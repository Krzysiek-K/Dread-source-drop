...
void c2p_asm(__a0 word *render, __a1 byte* dst, __a0 word *render2, __a5 const dword *lut0, __a6 const dword *lut1);		// asm
...
void _movep_l(byte *dst, dword value)
{
	dst[0] = (byte)(value>>24);
	dst[2] = (byte)(value>>16);
	dst[4] = (byte)(value>> 8);
...
void perform_c2p(void)
{
	...
	//for( int x=0; x<20; x++ )
	//{
	//	word *src = render_screen + x*400;
	//	word *dst = screen + (x<<2);
	//
	//	//c2p_asm(src, (byte*)dst, render_screen2, c2p_lut, c2p_lut2);
	//	//c2p_asm(src+200, (byte*)dst+1, render_screen2, c2p_lut, c2p_lut2);
	//
	//
	//	//c2p_asm(src, (byte*)dst, c2p_lut, c2p_lut2);
	//	//c2p_asm(src+200, (byte*)dst+1, c2p_lut, c2p_lut2);
	//
	//	//for( int y=0; y<1; y++ )
	//	//{
	//	//	c2p_asm(src, (byte*)dst, render_screen2, c2p_lut, c2p_lut2);
	//	//	c2p_asm(src+200, (byte*)dst+1, render_screen2, c2p_lut, c2p_lut2);
	//	//	
	//	////	value  = c2p_lut[src[0]>>2];
	//	////	value |= c2p_lut2[src[100]>>2];
	//	////	_movep_l((byte*)dst, value);
	//	////	_movep_l((byte*)dst+(320/8)*4, value);
	//	////
	//	////	value  = c2p_lut[src[200]>>2];
	//	////	value |= c2p_lut2[src[300]>>2];
	//	////	_movep_l((byte*)dst+1, value);
	//	////	_movep_l((byte*)dst+1+(320/8)*4, value);
	//	//
	//	//	src++;
	//	//	dst += (320/16)*4*2;	// skip two lines
	//	//	
	//	//	src++;
	//	//	dst += (320/16)*4*2;	// skip two lines
	//	//	
