    ...
    public _Dread_LineCore_x009
_Dread_LineCore_x009:

                                                    ;s d01---5-- a01234---       ================================ Ceil y1 Upper y2 gap ================================
...
.start:                                             ;- d--2--5-7 a--23-5--       ======== FIRST ITERATION STARTS HERE ========
    ...
    bge         .cmp_2                              ;C d-----5-7 a--23-5--  12   
                                                    ...
                                                    ;- d-----5-7 a--23-5--       ======== [Ceil] ========
                                                    ;F d-----5-7 a--23-5--       -------- [Ceil] --------
    swap.w      d2                                  ;F d-----5-7 a--23-5--   4   Select ymin
    move.w      d2, d7                              ;F d-----5-- a--23-5--   4   
    swap.w      d2                                  ;F d-----5-- a--23-5--   4   Select ymax
    sub.w       d2, d7                              ;F d-----5-- a--23-5--   4   
    add.w       d7, d7                              ;F d--2--5-- a--23-5--   4   
    lea.l       .ret_3(pc), a6                      ;F d--2--5-- a--23-5--   8   
    jmp         (a0,d7.w)                           ;F d--2--5-- a--23-5--  14   -> .ret_3
.ret_3:                                             ;F d--2--5-7 a--23-5--       
...
.cmp_2:                                             ;C d-----5-7 a--23-5--       -------- ymin < y1 && y0 <= ymax < y1 --------
    ...
    bge         .cmp_4                              ;C d-----5-7 a--23-5--  12   
                                                    ...
                                                    ;- d-----5-7 a--23-5--       ======== [Ceil Upper] ========
                                                    ;F d-----5-7 a--23-5--       -------- [Ceil --------
    sub.w       d0, d2                              ;F d-----5-7 a--23-5--   4   
    add.w       d2, d2                              ;F d-----5-7 a--23-5--   4   
    lea.l       .ret_5(pc), a6                      ;F d-----5-7 a--23-5--   8   
    jmp         (a0,d2.w)                           ;F d-----5-7 a--23-5--  14   -> .ret_5
.ret_5:                                             ;F d-----5-7 a--23-5--       
...
.cmp_1:                                             ;C d-----5-7 a--23-5--       -------- y1 <= ymax --------
    ...
    bge         .cmp_8                              ;C d-----5-7 a--23-5--  12   
                                                    ...
                                                    ;- d-----5-7 a--23-5--       ======== [Ceil Upper gap] ========
                                                    ;F d-----5-7 a--23-5--       -------- [Ceil --------
    sub.w       d0, d2                              ;F d-----5-7 a--23-5--   4   
    add.w       d2, d2                              ;F d-----5-7 a--23-5--   4   
    lea.l       .ret_9(pc), a6                      ;F d-----5-7 a--23-5--   8   
    jmp         (a0,d2.w)                           ;F d-----5-7 a--23-5--  14   -> .ret_9
.ret_9:                                             ;F d-----5-7 a--23-5--       
                                                    ;R d-----5-7 a--23-5--       -------- Upper --------
                                                    ;R d-----5-7 a--23-5--       -- Fill routine --
    move.w      d4, d7                              ;R d-----5-- a--23-5--   4   int lut_offset = (((word)s1)>>3) & ~3;
    lsr.w       #3, d7                              ;R d-----5-- a--23-5--  12   
