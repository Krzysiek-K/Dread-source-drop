    ...
    public _Dread_LineCore_x012p
_Dread_LineCore_x012p:

                                                    ;s d01---567 a01234---       ================================ Sky y1 gap ================================
    ...
    sub.w       _view_pos_z, d1                     ;s d--2--567 a-123-5--  16   
    muls.w      d1, d0                              ;s d--2--567 a-123-5--  70   
    move.w      _asm_line_s2, d5                    ;s d--2---67 a-123-5--  16   compute Y slope
    lsr.w       #5, d5                              ;s d--2---67 a-123-5--  16   
    muls.w      d1, d5                              ;s d--2---67 a-123-5--  70   
    sub.l       d0, d5                              ;s d-12---67 a-123-5--   8   
    divs.w      _asm_line_xlen, d5                  ;s d-12---67 a-123-5-- 170   
    move.b      d5, .trace_s+2                      ;s d-12---67 a-123-5--  16   subpixel step
    lsr.w       #8, d5                              ;s d-12---67 a-123-5--  22   
    ext.w       d5                                  ;s d-12---67 a-123-5--   4   
    move.w      d5, .trace_y0+2                     ;s d-12---67 a-123-5--  16   pixel step
    add.l       #ENGINE_Y_MID*256+128, d0           ;s d-12--567 a-123-5--  16   24.8 fixed
    lsl.l       #8, d0                              ;s d-12--567 a-123-5--  24   16.16 fixed
    swap.w      d4                                  ;s d-12--567 a-123-5--   4   
    move.w      d0, d4                              ;s d-12--567 a-123-5--   4   
    swap.w      d4                                  ;s d-12--567 a-123-5--   4   
    sub.w       d0, d0                              ;s d-12--567 a-123-5--   4   
    swap.w      d0                                  ;s d-12--567 a-123-5--   4   current Y value
    move.w      _asm_line_ds, .trace_s+4            ;s d-12--567 a-123-5--  28   
...
.start:                                             ;- d-12--567 a-123-5--       ======== FIRST ITERATION STARTS HERE ========
    ...
    bge         .cmp_1                              ;C d--2--567 a-123-5--  12   
                                                    ...
                                                    ;- d--2--567 a-123-5--       ======== [Sky] ========
                                                    ;S d--2--567 a-123-5--       -------- [Sky] --------
    lea.l       _FUNC_SKYCOPY+ENGINE_Y_MAX*2, a1    ;S d--2--567 a--23-5--  12   Sky copy func
    move.l      (a0)+, a2                           ;S d--2--567 a---3-5--  12   
    swap.w      d1                                  ;S d--2--567 a---3-5--   4   Select ymin
    add.w       d1, a2                              ;S d--2--567 a---3-5--   8   sky offset by ymin
    move.w      d1, d2                              ;S d-----567 a--23-5--   4   
    swap.w      d1                                  ;S d-----567 a--23-5--   4   Select ymax
    sub.w       d1, d2                              ;S d-----567 a--23-5--   4   
    add.w       d2, d2                              ;S d-1---567 a--23-5--   4   
    lea.l       .ret_2(pc), a6                      ;S d-1---567 a--23-5--   8   
    jmp         (a1,d2.w)                           ;S d-1---567 a--23-5--  14   -> .ret_2
.ret_2:                                             ;S d-12--567 a-123-5--       
...
.cmp_1:                                             ;C d--2--567 a-123-5--       -------- y0 <= ymax --------
    ...
    bge         .cmp_3                              ;C d--2--567 a-123-5--  12   
                                                    ...
                                                    ;- d--2--567 a-123-5--       ======== [Sky gap] ========
                                                    ;S d--2--567 a-123-5--       -------- [Sky --------
    lea.l       _FUNC_SKYCOPY+ENGINE_Y_MAX*2, a1    ;S d--2--567 a--23-5--  12   Sky copy func
    move.l      (a0)+, a2                           ;S d--2--567 a---3-5--  12   
    add.w       d1, a2                              ;S d--2--567 a---3-5--   8   sky offset by ymin
    sub.w       d0, d1                              ;S d--2--567 a--23-5--   4   
    add.w       d1, d1                              ;S d--2--567 a--23-5--   4   
    lea.l       .ret_4(pc), a6                      ;S d--2--567 a--23-5--   8   
    jmp         (a1,d1.w)                           ;S d--2--567 a--23-5--  14   -> .ret_4
.ret_4:                                             ;S d--2--567 a-123-5--       
...
.cmp_3:                                             ;C d-12--567 a-123-5--       -------- y0 <= ymin && y0 <= ymax --------
    ...
    addq.l      #4, a0                              ;S d-12--567 a-123-5--   8   SKY was skipped
    bra         .end_loop                           ;- d-12--567 a-123-5--  12   
                                                    ;- d-12--567 a-123-5--       
                                                    ;- d-12--567 a-123-5--       
