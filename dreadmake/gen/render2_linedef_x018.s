    ...
    public _Dread_LineCore_x018
_Dread_LineCore_x018:
...
.trace_tex:                                         ;1 d-----5-7 a-123----       
    add.w       #$8000, d6                          ;1 d-----5-7 a-123----   8   u += du
                                                    ;1 d-----5-7 a-123----       
...
.ret_6:                                             ;1 d-----5-- a-123----       
    ...
    move.w      d6, d5                              ;1 d-------- a-12-----   4   word tx = u1s;
...
.cmp_5:                                             ;1 d-----5-- a-123----       -------- y0 <= ymin < y1 && y0 <= ymax < y1 --------
    ...
    move.w      d6, d5                              ;1 d-------- a--23----   4   word tx = u1s;
...
.ret_10:                                            ;1 d-----5-7 a-123----       
    ...
    move.w      d6, d5                              ;1 d-------7 a-12-----   4   word tx = u1s;
...
.ret_30:                                            ;1 d-------7 a--23----       
    ...
    move.w      d6, d5                              ;1 d-------7 a--23----   4   word tx = u1s;
