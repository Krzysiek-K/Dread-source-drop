    ...
    public _Dread_LineCore_x023
_Dread_LineCore_x023:

                                                    ;0 d01---5-- a01234---       ================================ Sky y1 Upper y2 gap ================================
...
.trace_tex:                                         ;1 d--23-5-7 a--23-5--       
    add.w       #$8000, d6                          ;1 d--23-5-7 a--23-5--   8   u += du
                                                    ;1 d--23-5-7 a--23-5--       
...
.ret_5:                                             ;1 d---3-5-7 a--23-5--       
    ...
    move.l      (a3,d3.w), a3                       ;1 d-----5-7 a--2--5--  18   
                                                    ;1 d---3-5-7 a--2--5--       -- Texcoord (no persp) --
    move.w      d6, d3                              ;1 d-----5-7 a--2--5--   4   word tx = u1s;
    and.w       #$1F80, d3                          ;1 d-----5-7 a--2--5--   8   tx &= $1F80;
    move.l      .asm_tex_base(pc), a2               ;1 d-----5-7 a-----5--  16   -- Texture source --
...
.cmp_1:                                             ;1 d---3-5-7 a--23-5--       -------- y1 <= ymax --------
    ...
    move.w      rc_ymin(a4), d2                     ;1 d---3-5-7 a--23-5--  12   Load ymin
    cmp.w       d0, d2                              ;1 d---3-5-7 a--23-5--   4   ymin>=y0
    bge         .cmp_8                              ;1 d---3-5-7 a--23-5--  10   
                                                    ;1 d---3-5-7 a--23-5--       
                                                    ;1 d---3-5-7 a--23-5--       -------- ymin < y0 && y1 <= ymax --------
                                                    ;1 d---3-5-7 a--23-5--       ======== [Sky Upper gap] ========
                                                    ;1 d---3-5-7 a--23-5--       -------- [Sky --------
    lea.l       _FUNC_SKYCOPY+ENGINE_Y_MAX*2, a3    ;1 d---3-5-7 a--2--5--  12   Sky copy func
    move.l      (a0)+, a2                           ;1 d---3-5-7 a-----5--  12   
    add.w       d2, a2                              ;1 d---3-5-7 a-----5--   8   sky offset by ymin
    sub.w       d0, d2                              ;1 d---3-5-7 a--2--5--   4   
    add.w       d2, d2                              ;1 d---3-5-7 a--2--5--   4   
    lea.l       .ret_9, a6                          ;1 d---3-5-7 a--2--5--  12   
    jmp         (a3,d2.w)                           ;1 d---3-5-7 a--2--5--  14   
.ret_9:                                             ;1 d---3-5-7 a--23-5--       
                                                    ;1 d---3-5-7 a--23-5--       -------- Upper --------
                                                    ;1 d---3-5-7 a--23-5--       -- Fill routine --
    move.w      d4, d3                              ;1 d-----5-7 a--23-5--   4   int lut_offset = (((word)s1)>>3) & ~3;
    lsr.w       #3, d3                              ;1 d-----5-7 a--23-5--  12   
    ...
    move.l      .asm_tex_base(pc), a2               ;1 d-----5-7 a-----5--  16   -- Texture source --
    add.w       d3, a2                              ;1 d-----5-7 a-----5--   8   
    move.w      d1, d3                              ;1 d-----5-7 a--2--5--   4   bottom_offset = 4*yend
    add.w       d3, d3                              ;1 d-----5-7 a--2--5--   4   
    add.w       d3, d3                              ;1 d-----5-7 a--2--5--   4   
...
.ret_10:                                            ;1 d-----5-7 a--2--5--       
    ...
    move.w      d1, rc_ymin(a4)                     ;1 d--23-5-7 a--23-5--   8   Update rc_ymin with ystart
    move.l      a7, (a4)                            ;1 d--23-5-7 a--23-5--  12   Set future drawing start pointer to current pos
    bra         .end_loop                           ;1 d--23-5-7 a--23-5--  10   
                                                    ;1 d---3-5-7 a--23-5--       
.cmp_8:                                             ;1 d---3-5-7 a--23-5--       -------- y0 <= ymin && y1 <= ymax --------
    cmp.w       d1, d2                              ;1 d---3-5-7 a--23-5--   4   ymin>=y1
    bge         .cmp_11                             ;1 d---3-5-7 a--23-5--  10   
                                                    ;1 d---3-5-7 a--23-5--       
                                                    ;1 d---3-5-7 a--23-5--       -------- y0 <= ymin < y1 && y1 <= ymax --------
                                                    ;1 d---3-5-7 a--23-5--       ======== [Upper gap] ========
                                                    ;1 d---3-5-7 a--23-5--       -------- [Upper --------
                                                    ;1 d---3-5-7 a--23-5--       -- Fill routine --
    move.w      d4, d3                              ;1 d-----5-7 a--23-5--   4   int lut_offset = (((word)s1)>>3) & ~3;
    lsr.w       #3, d3                              ;1 d-----5-7 a--23-5--  12   
    ...
    add.w       d3, d3                              ;1 d-----5-7 a--2--5--   4   
    move.w      #$4ED6, (a3,d3.w)                   ;1 d-----5-7 a--2--5--  18   #$4ED6 -> (fill_routine, bottom_offset)
    add.w       d2, d2                              ;1 d-----5-7 a--2--5--   4   top_offset = 4*ymin
    add.w       d2, d2                              ;1 d-----5-7 a--2--5--   4   
    lea.l       .ret_12, a6                         ;1 d-----5-7 a--2--5--  12   
    jmp         (a3,d2.w)                           ;1 d-----5-7 a--2--5--  14   execute at (fill_routine, top_offset)
.ret_12:                                            ;1 d-----5-7 a--2--5--       
    move.w      #$1EEA, (a3,d3.w)                   ;1 d-----5-7 a--2--5--  18   #$1EEA -> (fill_routine, bottom_offset)
                                                    ;1 d---3-5-7 a--23-5--       -------- gap] --------
    swap.w      d2                                  ;1 d---3-5-7 a--23-5--   4   Select ymax
    move.w      d1, rc_ymin(a4)                     ;1 d--23-5-7 a--23-5--   8   Update rc_ymin with ystart
    ...
    bra         .end_loop                           ;1 d--23-5-7 a--23-5--  10   
                                                    ;1 d--23-5-7 a--23-5--       
.cmp_11:                                            ;1 d--23-5-7 a--23-5--       -------- y1 <= ymin && y1 <= ymax --------
