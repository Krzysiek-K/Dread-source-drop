    ...
    public _Dread_LineCore_x015
_Dread_LineCore_x015:

                                                    ;s d01---5-- a01234---       ================================ Sky y1 Upper y2 gap ================================
    ...
    sub.w       _view_pos_z, d2                     ;s d-----5-7 a-123-5--  16   
    muls.w      d2, d1                              ;s d-----5-7 a-123-5--  70   
    move.w      _asm_line_s2, d5                    ;s d-------7 a-123-5--  16   compute Y slope
    lsr.w       #5, d5                              ;s d-------7 a-123-5--  16   
    muls.w      d2, d5                              ;s d-------7 a-123-5--  70   
    sub.l       d1, d5                              ;s d--2----7 a-123-5--   8   
    divs.w      _asm_line_xlen, d5                  ;s d--2----7 a-123-5-- 170   
    move.b      d5, .trace_y0+2                     ;s d--2----7 a-123-5--  16   subpixel step
    lsr.w       #8, d5                              ;s d--2----7 a-123-5--  22   
    ext.w       d5                                  ;s d--2----7 a-123-5--   4   
    move.w      d5, .trace_y1+2                     ;s d--2----7 a-123-5--  16   pixel step
    add.l       #ENGINE_Y_MID*256+128, d1           ;s d--2--5-7 a-123-5--  16   24.8 fixed
    lsl.l       #8, d1                              ;s d--2--5-7 a-123-5--  24   16.16 fixed
    swap.w      d0                                  ;s d--2--5-7 a-123-5--   4   
    move.w      d1, d0                              ;s d--2--5-7 a-123-5--   4   
    swap.w      d0                                  ;s d--2--5-7 a-123-5--   4   
    sub.w       d1, d1                              ;s d--2--5-7 a-123-5--   4   
    swap.w      d1                                  ;s d--2--5-7 a-123-5--   4   current Y value
    move.w      _asm_line_ds, .trace_s+4            ;s d--2--5-7 a-123-5--  28   
...
.trace_tex:                                         ;I d--2--5-7 a--23-5--       
    add.w       #$8000, d6                          ;I d--2--5-7 a--23-5--   8   u += du
                                                    ;- d--2--5-7 a--23-5--       
.start:                                             ;- d--2--5-7 a--23-5--       ======== FIRST ITERATION STARTS HERE ========
    ...
    bge         .cmp_2                              ;C d-----5-7 a--23-5--  12   
                                                    ;C d-----5-7 a--23-5--       
                                                    ;C d-----5-7 a--23-5--       -------- ymin < y0 && ymax < y0 --------
                                                    ;- d-----5-7 a--23-5--       ======== [Sky] ========
                                                    ;S d-----5-7 a--23-5--       -------- [Sky] --------
    lea.l       _FUNC_SKYCOPY+ENGINE_Y_MAX*2, a3    ;S d-----5-7 a--2--5--  12   Sky copy func
    move.l      (a0)+, a2                           ;S d-----5-7 a-----5--  12   
    swap.w      d2                                  ;S d-----5-7 a-----5--   4   Select ymin
    add.w       d2, a2                              ;S d-----5-7 a-----5--   8   sky offset by ymin
    move.w      d2, d7                              ;S d-----5-- a--2--5--   4   
    swap.w      d2                                  ;S d-----5-- a--2--5--   4   Select ymax
    sub.w       d2, d7                              ;S d-----5-- a--2--5--   4   
    add.w       d7, d7                              ;S d--2--5-- a--2--5--   4   
    lea.l       .ret_3(pc), a6                      ;S d--2--5-- a--2--5--   8   
    jmp         (a3,d7.w)                           ;S d--2--5-- a--2--5--  14   -> .ret_3
.ret_3:                                             ;S d--2--5-7 a--23-5--       
...
.cmp_2:                                             ;C d-----5-7 a--23-5--       -------- ymin < y1 && y0 <= ymax < y1 --------
    ...
    bge         .cmp_4                              ;C d-----5-7 a--23-5--  12   
                                                    ;C d-----5-7 a--23-5--       
                                                    ;C d-----5-7 a--23-5--       -------- ymin < y0 && y0 <= ymax < y1 --------
                                                    ;- d-----5-7 a--23-5--       ======== [Sky Upper] ========
                                                    ;S d-----5-7 a--23-5--       -------- [Sky --------
    lea.l       _FUNC_SKYCOPY+ENGINE_Y_MAX*2, a3    ;S d-----5-7 a--2--5--  12   Sky copy func
    move.l      (a0)+, a2                           ;S d-----5-7 a-----5--  12   
    add.w       d2, a2                              ;S d-----5-7 a-----5--   8   sky offset by ymin
    sub.w       d0, d2                              ;S d-----5-7 a--2--5--   4   
    add.w       d2, d2                              ;S d-----5-7 a--2--5--   4   
    lea.l       .ret_5(pc), a6                      ;S d-----5-7 a--2--5--   8   
    jmp         (a3,d2.w)                           ;S d-----5-7 a--2--5--  14   -> .ret_5
.ret_5:                                             ;S d-----5-7 a--23-5--       
                                                    ;R d-----5-7 a--23-5--       -------- Upper] --------
    ...
    move.l      (a1,d7.w), a3                       ;R d-----5-- a--2--5--  18   
                                                    ;T d-----5-7 a--2--5--       -- Texcoord (no persp) --
    move.w      d6, d7                              ;T d-----5-- a--2--5--   4   word tx = u1s;
    and.w       #$1F80, d7                          ;T d-----5-- a--2--5--   8   tx &= $1F80;
    move.l      .asm_tex_base(pc), a2               ;T d-----5-- a-----5--  16   -- Texture source --
    ...
    add.w       d7, d7                              ;R d-----5-- a--2--5--   4   
    lea.l       .ret_6(pc), a6                      ;R d-----5-- a--2--5--   8   
    jmp         (a3,d7.w)                           ;R d-----5-- a--2--5--  14   -> .ret_6
.ret_6:                                             ;R d-----5-7 a--2--5--       
    ...
    bra         .end_loop                           ;- d--2--5-7 a--23-5--  12   
                                                    ;C d-----5-7 a--23-5--       
.cmp_4:                                             ;C d-----5-7 a--23-5--       -------- y0 <= ymin < y1 && y0 <= ymax < y1 --------
                                                    ;- d-----5-7 a--23-5--       ======== [Upper] ========
                                                    ;R d-----5-7 a--23-5--       -------- [Upper] --------
                                                    ;R d-----5-7 a--23-5--       -- Fill routine --
    move.w      d4, d7                              ;R d-----5-- a--23-5--   4   int lut_offset = (((word)s1)>>3) & ~3;
    ...
    add.w       d2, d2                              ;R d-----5-7 a--2--5--   4   
    lea.l       .ret_7(pc), a6                      ;R d-----5-7 a--2--5--   8   
    jmp         (a3,d2.w)                           ;R d-----5-7 a--2--5--  14   -> .ret_7
.ret_7:                                             ;R d-----5-7 a--2--5--       
    swap.w      d2                                  ;R d-----5-7 a--2--5--   4   Select ymax
    move.w      #$1EEA, (a3,d2.w)                   ;R d-----5-7 a--2--5--  18   #$1EEA -> (fill_routine, bottom_offset)
...
.cmp_1:                                             ;C d-----5-7 a--23-5--       -------- y1 <= ymax --------
    ...
    sub.w       d0, d2                              ;S d-----5-7 a--2--5--   4   
    add.w       d2, d2                              ;S d-----5-7 a--2--5--   4   
    lea.l       .ret_9(pc), a6                      ;S d-----5-7 a--2--5--   8   
    jmp         (a3,d2.w)                           ;S d-----5-7 a--2--5--  14   -> .ret_9
.ret_9:                                             ;S d-----5-7 a--23-5--       
                                                    ;R d-----5-7 a--23-5--       -------- Upper --------
                                                    ;R d-----5-7 a--23-5--       -- Fill routine --
    move.w      d4, d7                              ;R d-----5-- a--23-5--   4   int lut_offset = (((word)s1)>>3) & ~3;
    lsr.w       #3, d7                              ;R d-----5-- a--23-5--  12   
    ...
    add.w       d7, d7                              ;R d-----5-- a--2--5--   4   
    add.w       d7, d7                              ;R d-----5-- a--2--5--   4   
    lea.l       .ret_10(pc), a6                     ;R d-----5-- a--2--5--   8   
    jmp         (a3,d7.w)                           ;R d-----5-- a--2--5--  14   -> .ret_10
.ret_10:                                            ;R d-----5-7 a--2--5--       
    move.w      #$1EEA, (a3)                        ;R d-----5-7 a--2--5--  12   #$1EEA -> (fill_routine, bottom_offset)
                                                    ;G d-----5-7 a--23-5--       -------- gap] --------
    swap.w      d2                                  ;G d-----5-7 a--23-5--   4   Select ymax
    move.w      d1, rc_ymin-8(a4)                   ;G d--2--5-7 a--23-5--  12   Update rc_ymin with ystart
    move.l      a7, 0-8(a4)                         ;G d--2--5-7 a--23-5--  16   Set future drawing start pointer to current pos
    bra         .end_loop                           ;- d--2--5-7 a--23-5--  12   
                                                    ;C d-----5-7 a--23-5--       
.cmp_8:                                             ;C d-----5-7 a--23-5--       -------- y0 <= ymin && y1 <= ymax --------
    cmp.w       d1, d2                              ;C d-----5-7 a--23-5--   4   ymin>=y1
    bge         .cmp_11                             ;C d-----5-7 a--23-5--  12   
                                                    ;C d-----5-7 a--23-5--       
                                                    ;C d-----5-7 a--23-5--       -------- y0 <= ymin < y1 && y1 <= ymax --------
                                                    ;- d-----5-7 a--23-5--       ======== [Upper gap] ========
                                                    ;R d-----5-7 a--23-5--       -------- [Upper --------
                                                    ;R d-----5-7 a--23-5--       -- Fill routine --
    move.w      d4, d7                              ;R d-----5-- a--23-5--   4   int lut_offset = (((word)s1)>>3) & ~3;
    lsr.w       #3, d7                              ;R d-----5-- a--23-5--  12   
    ...
    add.w       d2, d2                              ;R d-----5-7 a--2--5--   4   top_offset = 4*ymin
    add.w       d2, d2                              ;R d-----5-7 a--2--5--   4   
    lea.l       .ret_12(pc), a6                     ;R d-----5-7 a--2--5--   8   
    jmp         (a3,d2.w)                           ;R d-----5-7 a--2--5--  14   -> .ret_12
.ret_12:                                            ;R d-----5-7 a--2--5--       
    move.w      #$1EEA, (a3)                        ;R d-----5-7 a--2--5--  12   #$1EEA -> (fill_routine, bottom_offset)
                                                    ;G d-----5-7 a--23-5--       -------- gap] --------
    swap.w      d2                                  ;G d-----5-7 a--23-5--   4   Select ymax
    move.w      d1, rc_ymin-8(a4)                   ;G d--2--5-7 a--23-5--  12   Update rc_ymin with ystart
    ...
    bra         .end_loop                           ;- d--2--5-7 a--23-5--  12   
                                                    ;C d--2--5-7 a--23-5--       
.cmp_11:                                            ;C d--2--5-7 a--23-5--       -------- y1 <= ymin && y1 <= ymax --------
                                                    ;- d--2--5-7 a--23-5--       ======== [gap] ========
