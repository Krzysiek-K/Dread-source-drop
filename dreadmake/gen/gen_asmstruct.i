...
; struct dos_fib
dos_fib_DiskKey         equ   0
dos_fib_DirEntryType    equ   4
dos_fib_FileName        equ   8
dos_fib_Protection      equ 116
dos_fib_EntryType       equ 120
dos_fib_Size            equ 124
dos_fib_NumBlocks       equ 128
dos_fib_Days            equ 132
dos_fib_Minute          equ 136
dos_fib_Tick            equ 140
dos_fib_Comment         equ 144
dos_fib_OwnerUID        equ 224
dos_fib_OwnerGID        equ 226
dos_fib_Reserved        equ 228
dos_fib_sizeof          equ 260

	if AMIGA_AUDIO_ENGINE_VERSION=1
; struct aud
aud_reg_base_1          equ   0
aud_irq_mask_1          equ   4
aud_dma_mask_1          equ   6
aud_state_1             equ   8
aud_volume_1            equ   9
aud_reg_base_2          equ  10
aud_irq_mask_2          equ  14
aud_dma_mask_2          equ  16
aud_state_2             equ  18
aud_volume_2            equ  19
aud_combined_irq_mask   equ  20
aud_combined_dma_mask   equ  22
aud_pending_sample      equ  24
aud_thing_owner         equ  28
aud_last_time           equ  32
aud_attenuation         equ  34
aud_sizeof              equ  36
	endif
...
audtrak_delay           equ   0
audtrak_flags           equ   2
audtrak_volume          equ   3
audtrak_sample          equ   4
audtrak_period_mul      equ   8
audtrak_period_mul_fract equ  10
audtrak_sizeof          equ  12
	endif

	if AMIGA_AUDIO_ENGINE_VERSION=2
; struct aud
aud_reg_base_1          equ   0
aud_reg_base_2          equ   4
aud_irq_mask            equ   8
aud_dma_mask            equ  10
aud_base_period         equ  12
aud_volume              equ  14
aud_stereo_mode         equ  15
aud_thing_owner         equ  16
aud_last_time           equ  20
aud_attenuation         equ  22
aud_timer_cmd           equ  24
aud_irq_cmd             equ  28
aud_t1_entry_count      equ  32
aud_sizeof              equ  34
	endif

; struct statblit
statblit_bltcon0        equ   0
statblit_bltcon1        equ   2
statblit_bltafwm        equ   4
statblit_bltalwm        equ   6
statblit_bltcdmod       equ   8
statblit_bltabmod       equ  10
statblit_source         equ  12
statblit_srcmask_offs   equ  16
statblit_target_offs    equ  18
statblit_bltsize        equ  20
statblit_next_blit      equ  22
statblit_sizeof         equ  26

; struct trk
trk_req_trackhead       equ   0
trk_req_destination     equ   2
trk_current_track       equ   6
trk_current_head        equ   8
trk_dma_trackhead       equ  10
trk_loaded_trackhead    equ  12
trk_sizeof              equ  14
