    ...
    public _Dread_LineCore_x013
_Dread_LineCore_x013:

                                                    ;0 d01---5-- a01234---       ================================ Ceil y1 gap y3 Lower ================================
    ...
    move.w      line_y3(a5), d2                     ;0 d---3-5-7 a-123----  12   
...
.cmp_2:                                             ;1 d---3-5-7 a-123----       -------- ymin < y1 && y0 <= ymax < y1 --------
    ...
    bge         .cmp_4                              ;1 d---3-5-7 a-123----  10   
                                                    ;1 d---3-5-7 a-123----       
                                                    ;1 d---3-5-7 a-123----       -------- ymin < y0 && y0 <= ymax < y1 --------
                                                    ;1 d---3-5-7 a-123----       ======== [Ceil gap] ========
                                                    ;1 d---3-5-7 a-123----       -------- [Ceil --------
    lea.l       _FUNC_COLORFILL+ENGINE_Y_MAX*2, a1  ;1 d---3-5-7 a--23----  12   Color filler func
    sub.w       d0, d2                              ;1 d---3-5-7 a--23----   4   
    add.w       d2, d2                              ;1 d---3-5-7 a--23----   4   
    move.b      line_ceil_col(a5), d5               ;1 d---3---7 a--23----  12   
    lea.l       .ret_5, a6                          ;1 d---3-5-7 a--23----  12   
    jmp         (a1,d2.w)                           ;1 d---3-5-7 a--23----  14   
.ret_5:                                             ;1 d---3-5-7 a-123----       
                                                    ;1 d---3-5-7 a-123----       -------- gap] --------
    swap.w      d2                                  ;1 d---3-5-7 a-123----   4   Select ymax
    move.w      d0, rc_ymin(a4)                     ;1 d--23-5-7 a-123----   8   Update rc_ymin with ystart
    move.l      a7, (a4)                            ;1 d--23-5-7 a-123----  12   Set future drawing start pointer to current pos
    bra         .end_loop                           ;1 d--23-5-7 a-123----  10   
                                                    ;1 d--23-5-7 a-123----       
.cmp_4:                                             ;1 d--23-5-7 a-123----       -------- y0 <= ymin < y1 && y0 <= ymax < y1 --------
...
.cmp_1:                                             ;1 d---3-5-7 a-123----       -------- y1 <= ymax --------
    ...
    bge         .cmp_6                              ;1 d---3-5-7 a-123----  10   
                                                    ...
                                                    ;1 d---3-5-7 a-123----       ======== [Ceil gap Lower] ========
                                                    ;1 d---3-5-7 a-123----       -------- [Ceil --------
    lea.l       _FUNC_COLORFILL+ENGINE_Y_MAX*2, a1  ;1 d---3-5-7 a--23----  12   Color filler func
    sub.w       d0, d2                              ;1 d---3-5-7 a--23----   4   
    add.w       d2, d2                              ;1 d---3-5-7 a--23----   4   
    move.b      line_ceil_col(a5), d5               ;1 d---3---7 a--23----  12   
    lea.l       .ret_7, a6                          ;1 d---3-5-7 a--23----  12   
    jmp         (a1,d2.w)                           ;1 d---3-5-7 a--23----  14   
.ret_7:                                             ;1 d---3-5-7 a-123----       
                                                    ;1 d---3-5-7 a-123----       -------- gap --------
    move.w      d0, rc_ymin(a4)                     ;1 d---3-5-7 a-123----   8   Update rc_ymin with ystart
    move.l      a7, (a4)                            ;1 d---3-5-7 a-123----  12   Set future drawing start pointer to current pos
    move.w      d1, rc_ymax(a4)                     ;1 d---3-5-7 a-123----   8   Update rc_ymax with yend
    move.w      d1, d3                              ;1 d-----5-7 a-123----   4   Add 2*(yend - ystart) to A7
    sub.w       d0, d3                              ;1 d-----5-7 a-123----   4   
    add.w       d3, d3                              ;1 d-----5-7 a-123----   4   
    add.w       d3, a7                              ;1 d-----5-7 a-123----   8   
    ...
    lea.l       _FN_SCALERS, a3                     ;1 d-----5-7 a-12-----  12   
    move.l      (a3,d3.w), a3                       ;1 d-----5-7 a-12-----  18   
                                                    ;1 d---3-5-7 a-12-----       -- Texcoord (no persp) --
    move.w      d6, d3                              ;1 d-----5-7 a-12-----   4   word tx = u1s;
    and.w       #$1F80, d3                          ;1 d-----5-7 a-12-----   8   tx &= $1F80;
    move.l      .asm_tex_base2(pc), a2              ;1 d-----5-7 a-1------  16   -- Texture source --
    add.w       d3, a2                              ;1 d-----5-7 a-1------   8   
    swap.w      d2                                  ;1 d---3-5-7 a-12-----   4   Select ymax
    add.w       d2, d2                              ;1 d---3-5-7 a-12-----   4   bottom_offset = 4*ymax
    add.w       d2, d2                              ;1 d---3-5-7 a-12-----   4   
    move.w      #$4ED6, (a3,d2.w)                   ;1 d---3-5-7 a-12-----  18   #$4ED6 -> (fill_routine, bottom_offset)
    move.w      d1, d3                              ;1 d-----5-7 a-12-----   4   top_offset = 4*ystart
    add.w       d3, d3                              ;1 d-----5-7 a-12-----   4   
    add.w       d3, d3                              ;1 d-----5-7 a-12-----   4   
    lea.l       .ret_8, a6                          ;1 d-----5-7 a-12-----  12   
    jmp         (a3,d3.w)                           ;1 d-----5-7 a-12-----  14   execute at (fill_routine, top_offset)
.ret_8:                                             ;1 d---3-5-7 a-12-----       
    move.w      #$1EEA, (a3,d2.w)                   ;1 d---3-5-7 a-12-----  18   #$1EEA -> (fill_routine, bottom_offset)
    bra         .end_loop                           ;1 d--23-5-7 a-123----  10   
                                                    ;1 d---3-5-7 a-123----       
.cmp_6:                                             ;1 d---3-5-7 a-123----       -------- y0 <= ymin && y1 <= ymax --------
    ...
    bge         .cmp_9                              ;1 d---3-5-7 a-123----  10   
                                                    ...
                                                    ;1 d---3-5-7 a-123----       -------- [gap --------
    move.w      d1, rc_ymax(a4)                     ;1 d---3-5-7 a-123----   8   Update rc_ymax with yend
    sub.w       d1, d2                              ;1 d---3-5-7 a-123----   4   Add 2*(yend - rc_ymin) to A7
