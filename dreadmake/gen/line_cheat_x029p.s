...
.start:                                             ;- d012----- a0123----       // FIRST ITERATION STARTS HERE
    ...
    add.w       lc_ceil_len_m128(a4), d0            ;F d--2----- a-123----  12   shorten to end at texture edge
    bge         .ceil_culled                        ;C d--2----- a-123----  12   
    lea.l       .ceil_ret(pc), a6                   ;F d--2----- a-123----   8   
    jmp         (a0,d0.w)                           ;F d--2----- a-123----  14   
.ceil_culled:                                       ;F d0-2----- a0123----       
    move.l      (a5), a7                            ;F d0-2----- a0123----  12   byte *dst = render_buffer + offs[x];
    add.w       lc_hole_end_0(a4), a7               ;F d0-2----- a0123----  16   
    bra         .floor_start                        ;F d0-2----- a0123----  12   
.ceil_ret:                                          ;F d0-2----- a0123----       
                                                    ;G d0-2----- a0123----       === Gap
    move.w      lc_ceil_ymin_m128(a4), rc_ymin(a5)  ;G d0-2----- a0123----  20   ymin
    add.w       lc_hole_size_m128_0(a4), a7         ;G d0-2----- a0123----  16   
                                                    ;F d0-2----- a0123----       === Floor]
