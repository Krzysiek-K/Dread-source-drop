    ...
    public _Dread_LineCore_x018p
_Dread_LineCore_x018p:

                                                    ;0 d01---5-- a01234---       ================================ Ceil y1 Upper y2 gap y3 Lower y4 Floor ================================
    ...
    move.l      a1, .asm_tex_base                   ;0 d0123-5-7 a--23----  20   
    ...
    move.w      _asm_line_ds, .trace_s+4            ;0 d-----5-7 a-123----  28   
...
.ret_6:                                             ;1 d-----5-- a-123----       
    ...
    move.l      (a3,d5.w), a3                       ;1 d-------- a-12-----  18   
                                                    ;1 d-----5-- a-12-----       -- Texcoord (persp) --
    move.l      d6, d5                              ;1 d-------- a-12-----   4   word tx = u1s /divu/ s1;
    divu.w      d4, d5                              ;1 d-------- a-12----- 140   
    and.w       #$1F80, d5                          ;1 d-------- a-12-----   8   tx &= $1F80;
    move.l      .asm_tex_base(pc), a2               ;1 d-------- a-1------  16   -- Texture source --
...
.cmp_5:                                             ;1 d-----5-- a-123----       -------- y0 <= ymin < y1 && y0 <= ymax < y1 --------
    ...
    move.l      (a1,d5.w), a1                       ;1 d-------- a--23----  18   
                                                    ;1 d-----5-- a--23----       -- Texcoord (persp) --
    move.l      d6, d5                              ;1 d-------- a--23----   4   word tx = u1s /divu/ s1;
    divu.w      d4, d5                              ;1 d-------- a--23---- 140   
    and.w       #$1F80, d5                          ;1 d-------- a--23----   8   tx &= $1F80;
    move.l      .asm_tex_base(pc), a2               ;1 d-------- a---3----  16   -- Texture source --
...
.ret_10:                                            ;1 d-----5-7 a-123----       
    ...
    move.l      (a3,d5.w), a3                       ;1 d-------7 a-12-----  18   
                                                    ;1 d-----5-7 a-12-----       -- Texcoord (persp) --
    move.l      d6, d5                              ;1 d-------7 a-12-----   4   word tx = u1s /divu/ s1;
    divu.w      d4, d5                              ;1 d-------7 a-12----- 140   
    and.w       #$1F80, d5                          ;1 d-------7 a-12-----   8   tx &= $1F80;
    move.l      .asm_tex_base(pc), a2               ;1 d-------7 a-1------  16   -- Texture source --
...
.ret_18:                                            ;1 d-------- a-12-----       
    ...
    divu.w      d4, d5                              ;1 d-------- a-12----- 140   
    and.w       #$1F80, d5                          ;1 d-------- a-12-----   8   tx &= $1F80;
    move.l      .asm_tex_base2(pc), a2              ;1 d-------- a-1------  16   -- Texture source --
    add.w       d5, a2                              ;1 d-------- a-1------   8   
    swap.w      d7                                  ;1 d-----5-- a-12-----   4   Select ymax
    add.w       d7, d7                              ;1 d-----5-- a-12-----   4   bottom_offset = 4*ymax
    add.w       d7, d7                              ;1 d-----5-- a-12-----   4   
...
.ret_20:                                            ;1 d-----5-7 a--23----       
    ...
    move.l      d6, d5                              ;1 d-------7 a--2-----   4   word tx = u1s /divu/ s1;
    divu.w      d4, d5                              ;1 d-------7 a--2----- 140   
...
.ret_26:                                            ;1 d-------- a--23----       
    ...
    divu.w      d4, d5                              ;1 d-------- a--23---- 140   
    and.w       #$1F80, d5                          ;1 d-------- a--23----   8   tx &= $1F80;
    move.l      .asm_tex_base2(pc), a2              ;1 d-------- a---3----  16   -- Texture source --
    add.w       d5, a2                              ;1 d-------- a---3----   8   
    swap.w      d7                                  ;1 d-----5-- a--23----   4   Select ymax
    add.w       d7, d7                              ;1 d-----5-- a--23----   4   bottom_offset = 4*ymax
    add.w       d7, d7                              ;1 d-----5-- a--23----   4   
...
.ret_30:                                            ;1 d-------7 a--23----       
    ...
    move.l      (a1,d5.w), a1                       ;1 d-------7 a--23----  18   
                                                    ;1 d-----5-7 a--23----       -- Texcoord (persp) --
    move.l      d6, d5                              ;1 d-------7 a--23----   4   word tx = u1s /divu/ s1;
    divu.w      d4, d5                              ;1 d-------7 a--23---- 140   
    and.w       #$1F80, d5                          ;1 d-------7 a--23----   8   tx &= $1F80;
    move.l      .asm_tex_base2(pc), a2              ;1 d-------7 a---3----  16   -- Texture source --
