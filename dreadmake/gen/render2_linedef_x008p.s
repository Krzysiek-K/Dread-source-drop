    ...
    public _Dread_LineCore_x008p
_Dread_LineCore_x008p:

                                                    ;s d01---5-- a01234---       ================================ Ceil y1 gap y3 Lower y4 Floor ================================
    ...
    move.w      line_y3(a5), d2                     ;s d---3-5-7 a-123----  12   
...
.trace_tex:                                         ;I d---3---7 a--2--5--       
    add.l       #$80000000, d6                      ;I d---3---7 a--2--5--  16   u += du
                                                    ;- d---3---7 a--2--5--       
...
.ret_5:                                             ;F d-------7 a--2--5--       
    swap.w      d5                                  ;F d-------7 a--2--5--   4   deselect ceiling color
                                                    ;G d-------7 a--2--5--       -------- gap] --------
    swap.w      d3                                  ;G d-------7 a--2--5--   4   Select ymax
    move.w      d0, rc_ymin-8(a4)                   ;G d---3---7 a--2--5--  12   Update rc_ymin with ystart
    move.l      a7, 0-8(a4)                         ;G d---3---7 a--2--5--  16   Set future drawing start pointer to current pos
    bra         .end_loop                           ;- d---3---7 a--2--5--  12   
                                                    ;C d---3---7 a--2--5--       
.cmp_4:                                             ;C d---3---7 a--2--5--       -------- y0 <= ymin < y1 && y0 <= ymax < y1 --------
                                                    ;- d---3---7 a--2--5--       ======== [gap] ========
                                                    ;G d---3---7 a--2--5--       -------- [gap] --------
                                                    ;G d---3---7 a--2--5--       nothing to be done
    bra         .end_loop                           ;- d---3---7 a--2--5--  12   
                                                    ;C d-------7 a--2--5--       
.cmp_1:                                             ;C d-------7 a--2--5--       -------- y1 <= ymax --------
    swap.w      d3                                  ;C d-------7 a--2--5--   4   Select ymin
    cmp.w       d1, d3                              ;C d-------7 a--2--5--   4   ymin>=y1
    bge         .cmp_6                              ;C d-------7 a--2--5--  12   
                                                    ;C d-------7 a--2--5--       
                                                    ;C d-------7 a--2--5--       -------- ymin < y1 && y1 <= ymax --------
    swap.w      d3                                  ;C d-------7 a--2--5--   4   Select ymax
    cmp.w       d2, d3                              ;C d-------7 a--2--5--   4   ymax>=y2
    bge         .cmp_7                              ;C d-------7 a--2--5--  12   
                                                    ;C d-------7 a--2--5--       
    ...
    bge         .cmp_8                              ;C d-------7 a--2--5--  12   
                                                    ...
                                                    ;- d-------7 a--2--5--       ======== [Ceil gap Lower] ========
                                                    ;F d-------7 a--2--5--       -------- [Ceil --------
    sub.w       d0, d3                              ;F d-------7 a--2--5--   4   
    add.w       d3, d3                              ;F d-------7 a--2--5--   4   
    swap.w      d5                                  ;F d-------7 a--2--5--   4   select ceiling color
    lea.l       .ret_9(pc), a6                      ;F d-------7 a--2--5--   8   
    jmp         (a1,d3.w)                           ;F d-------7 a--2--5--  14   -> .ret_9
.ret_9:                                             ;F d-------7 a--2--5--       
    swap.w      d5                                  ;F d-------7 a--2--5--   4   deselect ceiling color
                                                    ;G d-------7 a--2--5--       -------- gap --------
    move.w      d0, rc_ymin-8(a4)                   ;G d-------7 a--2--5--  12   Update rc_ymin with ystart
    move.l      a7, 0-8(a4)                         ;G d-------7 a--2--5--  16   Set future drawing start pointer to current pos
    move.w      d1, rc_ymax-8(a4)                   ;G d-------7 a--2--5--  12   Update rc_ymax with yend
    move.w      d1, d7                              ;G d-------- a--2--5--   4   Add 2*(yend - ystart) to A7
    sub.w       d0, d7                              ;G d-------- a--2--5--   4   
    add.w       d7, d7                              ;G d-------- a--2--5--   4   
    add.w       d7, a7                              ;G d-------- a--2--5--   8   
                                                    ;R d-------7 a--2--5--       -------- Lower] --------
    ...
    move.l      (a3,d7.w), a5                       ;R d-------- a--2-----  18   
                                                    ;T d-------7 a--2-----       -- Texcoord (persp) --
    move.l      d6, d7                              ;T d-------- a--2-----   4   word tx = u1s /divu/ s1;
    divu.w      d4, d7                              ;T d-------- a--2----- 140   
    ...
    add.w       d7, d7                              ;R d-------- a--2-----   4   
    lea.l       .ret_10(pc), a6                     ;R d-------- a--2-----   8   
    jmp         (a5,d7.w)                           ;R d-------- a--2-----  14   -> .ret_10
.ret_10:                                            ;R d-------7 a--2-----       
    move.w      #$1EEA, (a5,d3.w)                   ;R d-------7 a--2-----  18   #$1EEA -> (fill_routine, bottom_offset)
    bra         .end_loop                           ;- d---3---7 a--2--5--  12   
                                                    ;C d-------7 a--2--5--       
.cmp_8:                                             ;C d-------7 a--2--5--       -------- y0 <= ymin < y1 && y1 <= ymax < y2 --------
                                                    ;- d-------7 a--2--5--       ======== [gap Lower] ========
                                                    ;G d-------7 a--2--5--       -------- [gap --------
    move.w      d1, rc_ymax-8(a4)                   ;G d-------7 a--2--5--  12   Update rc_ymax with yend
    sub.w       d1, d3                              ;G d-------7 a--2--5--   4   Add 2*(yend - rc_ymin) to A7
    neg.w       d3                                  ;G d-------7 a--2--5--   4   
    add.w       d3, d3                              ;G d-------7 a--2--5--   4   
    add.w       d3, a7                              ;G d-------7 a--2--5--   8   
                                                    ;R d-------7 a--2--5--       -------- Lower] --------
                                                    ;R d-------7 a--2--5--       -- Fill routine --
    move.w      d4, d7                              ;R d-------- a--2--5--   4   int lut_offset = (((word)s1)>>3) & ~3;
    lsr.w       #3, d7                              ;R d-------- a--2--5--  12   
    ...
    jmp         (a5,d7.w)                           ;R d-------- a--2-----  14   -> .ret_11
.ret_11:                                            ;R d-------7 a--2-----       
    move.w      #$1EEA, (a5,d3.w)                   ;R d-------7 a--2-----  18   #$1EEA -> (fill_routine, bottom_offset)
    bra         .end_loop                           ;- d---3---7 a--2--5--  12   
                                                    ;C d-------7 a--2--5--       
.cmp_7:                                             ;C d-------7 a--2--5--       -------- ymin < y1 && y2 <= ymax --------
    swap.w      d3                                  ;C d-------7 a--2--5--   4   Select ymin
    cmp.w       d0, d3                              ;C d-------7 a--2--5--   4   ymin>=y0
    bge         .cmp_12                             ;C d-------7 a--2--5--  12   
                                                    ;C d-------7 a--2--5--       
                                                    ;C d-------7 a--2--5--       -------- ymin < y0 && y2 <= ymax --------
                                                    ;- d-------7 a--2--5--       ======== [Ceil gap Lower Floor] ========
                                                    ;F d-------7 a--2--5--       -------- [Ceil --------
    sub.w       d0, d3                              ;F d-------7 a--2--5--   4   
    add.w       d3, d3                              ;F d-------7 a--2--5--   4   
    swap.w      d5                                  ;F d-------7 a--2--5--   4   select ceiling color
    lea.l       .ret_13(pc), a6                     ;F d-------7 a--2--5--   8   
    jmp         (a1,d3.w)                           ;F d-------7 a--2--5--  14   -> .ret_13
.ret_13:                                            ;F d-------7 a--2--5--       
    swap.w      d5                                  ;F d-------7 a--2--5--   4   deselect ceiling color
                                                    ;G d-------7 a--2--5--       -------- gap --------
    move.w      d0, rc_ymin-8(a4)                   ;G d-------7 a--2--5--  12   Update rc_ymin with ystart
    ...
    add.w       d7, d7                              ;R d-------- a--2-----   4   
    add.w       d7, d7                              ;R d-------- a--2-----   4   
    lea.l       .ret_14(pc), a6                     ;R d-------- a--2-----   8   
    jmp         (a5,d7.w)                           ;R d-------- a--2-----  14   -> .ret_14
.ret_14:                                            ;R d-------7 a--2-----       
    ...
    jmp         (a1,d3.w)                           ;F d-------7 a--2--5--  14   -> .end_loop
                                                    ;C d-------7 a--2--5--       
.cmp_12:                                            ;C d-------7 a--2--5--       -------- y0 <= ymin < y1 && y2 <= ymax --------
                                                    ;- d-------7 a--2--5--       ======== [gap Lower Floor] ========
                                                    ;G d-------7 a--2--5--       -------- [gap --------
    move.w      d1, rc_ymax-8(a4)                   ;G d-------7 a--2--5--  12   Update rc_ymax with yend
    sub.w       d1, d3                              ;G d-------7 a--2--5--   4   Add 2*(yend - rc_ymin) to A7
    neg.w       d3                                  ;G d-------7 a--2--5--   4   
...
.ret_15:                                            ;R d-------7 a--2-----       
    ...
    jmp         (a1,d3.w)                           ;F d-------7 a--2--5--  14   -> .end_loop
                                                    ;C d-------7 a--2--5--       
.cmp_6:                                             ;C d-------7 a--2--5--       -------- y1 <= ymin && y1 <= ymax --------
    swap.w      d3                                  ;C d-------7 a--2--5--   4   Select ymax
    cmp.w       d2, d3                              ;C d-------7 a--2--5--   4   ymax>=y2
    ...
    add.w       d3, d3                              ;R d-------7 a--2-----   4   
    lea.l       .ret_17(pc), a6                     ;R d-------7 a--2-----   8   
    jmp         (a5,d3.w)                           ;R d-------7 a--2-----  14   -> .ret_17
.ret_17:                                            ;R d-------7 a--2-----       
    swap.w      d3                                  ;R d-------7 a--2-----   4   Select ymax
    move.w      #$1EEA, (a5,d3.w)                   ;R d-------7 a--2-----  18   #$1EEA -> (fill_routine, bottom_offset)
    moveq.l     #0, d3                              ;G d-------7 a--2--5--   4   Disable further rendering - clear ymin/ymax
    ...
    bra         .end_loop                           ;- d---3---7 a--2--5--  12   
                                                    ;C d-------7 a--2--5--       
.cmp_16:                                            ;C d-------7 a--2--5--       -------- y1 <= ymin && y2 <= ymax --------
    swap.w      d3                                  ;C d-------7 a--2--5--   4   Select ymin
    cmp.w       d2, d3                              ;C d-------7 a--2--5--   4   ymin>=y2
    bge         .cmp_18                             ;C d-------7 a--2--5--  12   
                                                    ;C d-------7 a--2--5--       
    ...
    add.w       d3, d3                              ;R d-------7 a--2-----   4   top_offset = 4*ymin
    add.w       d3, d3                              ;R d-------7 a--2-----   4   
    lea.l       .ret_19(pc), a6                     ;R d-------7 a--2-----   8   
    jmp         (a5,d3.w)                           ;R d-------7 a--2-----  14   -> .ret_19
.ret_19:                                            ;R d-------7 a--2-----       
    move.w      #$1EEA, (a5)                        ;R d-------7 a--2-----  12   #$1EEA -> (fill_routine, bottom_offset)
                                                    ;F d-------7 a--2--5--       -------- Floor] --------
    swap.w      d3                                  ;F d-------7 a--2--5--   4   Select ymax
    ...
    jmp         (a1,d3.w)                           ;F d-------7 a--2--5--  14   -> .end_loop
                                                    ;C d-------7 a--2--5--       
.cmp_18:                                            ;C d-------7 a--2--5--       -------- y2 <= ymin && y2 <= ymax --------
                                                    ;- d-------7 a--2--5--       ======== [Floor] ========
                                                    ;F d-------7 a--2--5--       -------- [Floor] --------
    move.w      d3, d7                              ;F d-------- a--2--5--   4   
    swap.w      d3                                  ;F d-------- a--2--5--   4   Select ymax
