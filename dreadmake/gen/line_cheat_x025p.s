    ...
    public _Dread_LineCoreCheat_x025p
_Dread_LineCoreCheat_x025p:
...
.sky_ret:                                           ;S d01------ a01------       
                                                    ;T d01------ a01------       === Texcoord
    move.l      d6, d0                              ;T d-1------ a01------   4   word tx = u1s /divu/ s1;
    divu.w      d4, d0                              ;T d-1------ a01------ 140   
    ...
    add.w       d0, a2                              ;T d-1------ a01------   8   void *tex @ a2 = _asm_tex_base + tx;
                                                    ;R d01------ a01------       === Upper
    move.l      lc_upper_start_m128(a4), a0         ;R d01------ a-1------  16   void *fn = line_cheat.upper_start_m64;
    move.w      lc_upper_len_m128_m96(a4), d0       ;R d-1------ a-1------  12   $ fn[line_cheat.upper_len_m64_0] = $4ED6;  (L = -64..0 / -128..0)
...
.upper_ret:                                         ;R d-1------ a-1------       
    move.w      #$1EEA, (a0,d0.w)                   ;R d-1------ a-1------  18   $ fn[line_cheat.upper_len_m64_0] = $1EEA;
                                                    ;G d01------ a01------       === Gap
    move.w      lc_ceil_ymin_m96(a4), rc_ymin(a5)   ;G d01------ a01------  20   ymin
    add.w       lc_hole_size_m96_0(a4), a7          ;G d01------ a01------  16   
                                                    ;F d01------ a01------       === Floor]
.floor_start:                                       ;F d01------ a01------       
    ...
    move.w      d0, rc_ymax(a5)                     ;F d-1------ a-1------   8   ymax = Gap end
...
.upper_culled:                                      ;- d01------ a01------       Variant 1
                                                    ;G d01------ a01------       === !Gap
    move.l      (a5), a7                            ;G d01------ a01------  12   byte *dst = render_buffer + offs[x];
    add.w       lc_hole_end_0(a4), a7               ;G d01------ a01------  16   
                                                    ;F d01------ a01------       === Floor]
.floor_start1:                                      ;F d01------ a01------       
    lea.l       _FUNC_COLORFILL+ENGINE_Y_MID*2, a0  ;F d01------ a-1------  12   Color filler func
    move.w      lc_floor_start_0(a4), d0            ;F d-1------ a-1------  12   jsr (fn1,d0)		LUT.w:	Fill func start		(x2)	(fills to screen end)
    move.w      d0, rc_ymax(a5)                     ;F d-1------ a-1------   8   ymax = Gap end
    sub.w       d2, d0                              ;F d-1------ a-1------   4   clip ymax
    lea.l       .floor_ret1(pc), a6                 ;F d-12----- a-1------   8   
    jmp         (ENGINE_Y_MAX-ENGINE_Y_MID)*2(a0,d0.w);F d-12----- a-1------  14   
.floor_ret1:                                        ;F d012----- a01------       
    dbra.w      d3, .loop                           ;- d012----- a01------  12   LOOP END
    bra         .end                                ;- d012----- a01------  12   End of variant
.skyceil_culled:                                    ;- d01------ a01------       Variant 2
                                                    ;T d01------ a01------       === Texcoord
    move.l      d6, d0                              ;T d-1------ a01------   4   word tx = u1s /divu/ s1;
    divu.w      d4, d0                              ;T d-1------ a01------ 140   
    and.w       #$1F80, d0                          ;T d-1------ a01------   8   tx &= $1F80;
    ...
    add.w       d0, a2                              ;T d-1------ a01------   8   void *tex @ a2 = _asm_tex_base + tx;
                                                    ;R d01------ a01------       === ![Upper
    move.w      rc_ymin(a5), d1                     ;R d0------- a01------  12   ymin
    add.w       #-ENGINE_Y_MID*2, d1                ;R d0------- a01------   8   
    add.w       d1, d1                              ;R d0------- a01------   4   
    move.w      lc_upper_endpos_m96(a4), d0         ;R d-------- a01------  12   $ fn[line_cheat.upper_len_m64_0] = $4ED6;  (L = -64..0 / -128..0)
    cmp.w       d0, d1                              ;C d-------- a01------   4   
    bge         .upper_culled2                      ;C d-------- a01------  12   
    move.l      lc_scaler_fn(a4), a0                ;R d-------- a-1------  16   void *fn = line_cheat.upper_start_m64;
    move.w      #$4ED6, (a0,d0.w)                   ;R d-------- a-1------  18   
    lea.l       .upper_ret2(pc), a6                 ;R d-------- a-1------   8   
    jmp         (a0,d1.w)                           ;R d-------- a-1------  14   $ call_a6(fn)	(Z = -64 / -128)
.upper_ret2:                                        ;R d-1------ a-1------       
    move.w      #$1EEA, (a0,d0.w)                   ;R d-1------ a-1------  18   $ fn[line_cheat.upper_len_m64_0] = $1EEA;
.upper_skip2:                                       ;R d01------ a01------       
                                                    ;G d01------ a01------       === Gap
    move.w      lc_ceil_ymin_m96(a4), rc_ymin(a5)   ;G d01------ a01------  20   ymin
    add.w       lc_hole_size_m96_0(a4), a7          ;G d01------ a01------  16   
                                                    ;F d01------ a01------       === Floor]
.floor_start2:                                      ;F d01------ a01------       
    lea.l       _FUNC_COLORFILL+ENGINE_Y_MID*2, a0  ;F d01------ a-1------  12   Color filler func
    move.w      lc_floor_start_0(a4), d0            ;F d-1------ a-1------  12   jsr (fn1,d0)		LUT.w:	Fill func start		(x2)	(fills to screen end)
    move.w      d0, rc_ymax(a5)                     ;F d-1------ a-1------   8   ymax = Gap end
    sub.w       d2, d0                              ;F d-1------ a-1------   4   clip ymax
    lea.l       .floor_ret2(pc), a6                 ;F d-12----- a-1------   8   
    jmp         (ENGINE_Y_MAX-ENGINE_Y_MID)*2(a0,d0.w);F d-12----- a-1------  14   
.floor_ret2:                                        ;F d012----- a01------       
    dbra.w      d3, .loop                           ;- d012----- a01------  12   LOOP END
    bra         .end                                ;- d012----- a01------  12   End of variant
.upper_culled2:                                     ;- d01------ a01------       Variant 3
                                                    ;G d01------ a01------       === !Gap
    move.l      (a5), a7                            ;G d01------ a01------  12   byte *dst = render_buffer + offs[x];
    add.w       lc_hole_end_0(a4), a7               ;G d01------ a01------  16   
                                                    ;F d01------ a01------       === Floor]
.floor_start3:                                      ;F d01------ a01------       
    lea.l       _FUNC_COLORFILL+ENGINE_Y_MID*2, a0  ;F d01------ a-1------  12   Color filler func
    move.w      lc_floor_start_0(a4), d0            ;F d-1------ a-1------  12   jsr (fn1,d0)		LUT.w:	Fill func start		(x2)	(fills to screen end)
    move.w      d0, rc_ymax(a5)                     ;F d-1------ a-1------   8   ymax = Gap end
    sub.w       d2, d0                              ;F d-1------ a-1------   4   clip ymax
    lea.l       .floor_ret3(pc), a6                 ;F d-12----- a-1------   8   
    jmp         (ENGINE_Y_MAX-ENGINE_Y_MID)*2(a0,d0.w);F d-12----- a-1------  14   
.floor_ret3:                                        ;F d012----- a01------       
    dbra.w      d3, .loop                           ;- d012----- a01------  12   LOOP END
    bra         .end                                ;- d012----- a01------  12   End of variant
