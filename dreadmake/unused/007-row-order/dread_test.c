...
void FX_DreadTest(void)
{
	...
	temp_X		= (word*)(blockmem1+2+8400*4+16000+40);
	copper_A	= (word*)(blockmem1+2+8400*4+16000+40+8000);
	...
	temp_Y		= (word*)(blockmem2+2+8400*4+16000+40);
	copper_B	= (word*)(blockmem2+2+8400*4+16000+40+8000);
