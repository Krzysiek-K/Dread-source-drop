    ...
    public _Dread_LineCoreCheat_x032p
_Dread_LineCoreCheat_x032p:
...
.start:                                             ;- d012----- a012-----       // FIRST ITERATION STARTS HERE
    ...
    move.w      lc_ceil_len_m96(a4), d0             ;S d-12----- a-12-----  12   jsr(fn1, d0) LUT.w:	Ceil length(x2)
    lea.l       .sky_ret(pc), a6                    ;S d-12----- a-12-----   8   
    jmp         (a0,d0.w)                           ;S d-12----- a-12-----  14   
.sky_ret:                                           ;S d012----- a012-----       
                                                    ;G d012----- a012-----       === Gap
    move.w      lc_ceil_ymin_m96(a4), rc_ymin(a5)   ;G d012----- a012-----  20   ymin
    add.w       lc_hole_size_m96_0(a4), a7          ;G d012----- a012-----  16   
                                                    ;F d012----- a012-----       === Floor
