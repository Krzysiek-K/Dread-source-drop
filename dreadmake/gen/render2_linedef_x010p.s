    ...
    public _Dread_LineCore_x010p
_Dread_LineCore_x010p:

                                                    ;s d01---5-- a01234---       ================================ Ceil y1 Upper y2 gap y3 Floor ================================
...
.ret_12:                                            ;R d-------7 a--2-----       
    ...
    move.w      d1, rc_ymin-8(a4)                   ;G d---3---7 a--2--5--  12   Update rc_ymin with ystart
...
.cmp_10:                                            ;C d-------7 a--2--5--       -------- y0 <= ymin < y1 && y1 <= ymax < y2 --------
    ...
    add.w       d3, d3                              ;R d-------7 a--2-----   4   top_offset = 4*ymin
    add.w       d3, d3                              ;R d-------7 a--2-----   4   
    lea.l       .ret_13(pc), a6                     ;R d-------7 a--2-----   8   
    jmp         (a5,d3.w)                           ;R d-------7 a--2-----  14   -> .ret_13
.ret_13:                                            ;R d-------7 a--2-----       
    move.w      #$1EEA, (a5)                        ;R d-------7 a--2-----  12   #$1EEA -> (fill_routine, bottom_offset)
                                                    ;G d-------7 a--2--5--       -------- gap] --------
    swap.w      d3                                  ;G d-------7 a--2--5--   4   Select ymax
...
.cmp_9:                                             ;C d-------7 a--2--5--       -------- ymin < y1 && y2 <= ymax --------
    swap.w      d3                                  ;C d-------7 a--2--5--   4   Select ymin
    cmp.w       d0, d3                              ;C d-------7 a--2--5--   4   ymin>=y0
    bge         .cmp_14                             ;C d-------7 a--2--5--  12   
                                                    ;C d-------7 a--2--5--       
                                                    ;C d-------7 a--2--5--       -------- ymin < y0 && y2 <= ymax --------
                                                    ;- d-------7 a--2--5--       ======== [Ceil Upper gap Floor] ========
                                                    ;F d-------7 a--2--5--       -------- [Ceil --------
    sub.w       d0, d3                              ;F d-------7 a--2--5--   4   
    add.w       d3, d3                              ;F d-------7 a--2--5--   4   
    swap.w      d5                                  ;F d-------7 a--2--5--   4   select ceiling color
    lea.l       .ret_15(pc), a6                     ;F d-------7 a--2--5--   8   
    jmp         (a1,d3.w)                           ;F d-------7 a--2--5--  14   -> .ret_15
.ret_15:                                            ;F d-------7 a--2--5--       
    swap.w      d5                                  ;F d-------7 a--2--5--   4   deselect ceiling color
                                                    ;R d-------7 a--2--5--       -------- Upper --------
                                                    ;R d-------7 a--2--5--       -- Fill routine --
    ...
    add.w       d7, d7                              ;R d-------- a--2-----   4   
    add.w       d7, d7                              ;R d-------- a--2-----   4   
    lea.l       .ret_16(pc), a6                     ;R d-------- a--2-----   8   
    jmp         (a5,d7.w)                           ;R d-------- a--2-----  14   -> .ret_16
.ret_16:                                            ;R d-------7 a--2-----       
    move.w      #$1EEA, (a5)                        ;R d-------7 a--2-----  12   #$1EEA -> (fill_routine, bottom_offset)
                                                    ;G d-------7 a--2--5--       -------- gap --------
    move.w      d1, rc_ymin-8(a4)                   ;G d-------7 a--2--5--  12   Update rc_ymin with ystart
    move.l      a7, 0-8(a4)                         ;G d-------7 a--2--5--  16   Set future drawing start pointer to current pos
    move.w      d2, rc_ymax-8(a4)                   ;G d-------7 a--2--5--  12   Update rc_ymax with yend
    move.w      d2, d7                              ;G d-------- a--2--5--   4   Add 2*(yend - ystart) to A7
    sub.w       d1, d7                              ;G d-------- a--2--5--   4   
    ...
    jmp         (a1,d3.w)                           ;F d-------7 a--2--5--  14   -> .end_loop
                                                    ;C d-------7 a--2--5--       
.cmp_14:                                            ;C d-------7 a--2--5--       -------- y0 <= ymin < y1 && y2 <= ymax --------
                                                    ;- d-------7 a--2--5--       ======== [Upper gap Floor] ========
                                                    ;R d-------7 a--2--5--       -------- [Upper --------
                                                    ;R d-------7 a--2--5--       -- Fill routine --
    move.w      d4, d7                              ;R d-------- a--2--5--   4   int lut_offset = (((word)s1)>>3) & ~3;
    lsr.w       #3, d7                              ;R d-------- a--2--5--  12   
...
.cmp_8:                                             ;C d-------7 a--2--5--       -------- y1 <= ymin && y1 <= ymax --------
    ...
    bge         .cmp_18                             ;C d-------7 a--2--5--  12   
                                                    ;C d---3---7 a--2--5--       
                                                    ;C d---3---7 a--2--5--       -------- y1 <= ymin < y2 && y1 <= ymax < y2 --------
                                                    ;- d---3---7 a--2--5--       ======== [gap] ========
                                                    ;G d---3---7 a--2--5--       -------- [gap] --------
                                                    ;G d---3---7 a--2--5--       nothing to be done
    bra         .end_loop                           ;- d---3---7 a--2--5--  12   
                                                    ;C d-------7 a--2--5--       
.cmp_18:                                            ;C d-------7 a--2--5--       -------- y1 <= ymin && y2 <= ymax --------
    swap.w      d3                                  ;C d-------7 a--2--5--   4   Select ymin
    cmp.w       d2, d3                              ;C d-------7 a--2--5--   4   ymin>=y2
    bge         .cmp_19                             ;C d-------7 a--2--5--  12   
                                                    ;C d-------7 a--2--5--       
                                                    ;C d-------7 a--2--5--       -------- y1 <= ymin < y2 && y2 <= ymax --------
                                                    ;- d-------7 a--2--5--       ======== [gap Floor] ========
                                                    ;G d-------7 a--2--5--       -------- [gap --------
    move.w      d2, rc_ymax-8(a4)                   ;G d-------7 a--2--5--  12   Update rc_ymax with yend
    sub.w       d2, d3                              ;G d-------7 a--2--5--   4   Add 2*(yend - rc_ymin) to A7
    ...
    jmp         (a1,d3.w)                           ;F d-------7 a--2--5--  14   -> .end_loop
                                                    ;C d-------7 a--2--5--       
.cmp_19:                                            ;C d-------7 a--2--5--       -------- y2 <= ymin && y2 <= ymax --------
                                                    ;- d-------7 a--2--5--       ======== [Floor] ========
                                                    ;F d-------7 a--2--5--       -------- [Floor] --------
    move.w      d3, d7                              ;F d-------- a--2--5--   4   
    swap.w      d3                                  ;F d-------- a--2--5--   4   Select ymax
