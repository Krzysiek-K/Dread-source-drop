    ...
    public _Dread_LineCore_x003p
_Dread_LineCore_x003p:

                                                    ;s d01---5-- a01234---       ================================ Sky y1 Upper y2 Lower y4 Floor ================================
...
.trace_tex:                                         ;I d---3-5-7 a--2--5--       
    add.l       #$80000000, d6                      ;I d---3-5-7 a--2--5--  16   u += du
                                                    ;- d---3-5-7 a--2--5--       
...
.ret_5:                                             ;S d-----5-7 a--2--5--       
    ...
    move.l      (a5,d7.w), a5                       ;R d-----5-- a--2-----  18   
                                                    ;T d-----5-7 a--2-----       -- Texcoord (persp) --
    move.l      d6, d7                              ;T d-----5-- a--2-----   4   word tx = u1s /divu/ s1;
    divu.w      d4, d7                              ;T d-----5-- a--2----- 140   
...
.cmp_4:                                             ;C d-----5-7 a--2--5--       -------- y0 <= ymin < y1 && y0 <= ymax < y1 --------
    ...
    jmp         (a5,d3.w)                           ;R d-----5-7 a--2-----  14   -> .ret_7
.ret_7:                                             ;R d-----5-7 a--2-----       
    swap.w      d3                                  ;R d-----5-7 a--2-----   4   Select ymax
    move.w      #$1EEA, (a5,d3.w)                   ;R d-----5-7 a--2-----  18   #$1EEA -> (fill_routine, bottom_offset)
...
.cmp_1:                                             ;C d-----5-7 a--2--5--       -------- y1 <= ymax --------
    ...
    bge         .cmp_9                              ;C d-----5-7 a--2--5--  12   
                                                    ;C d-----5-7 a--2--5--       
                                                    ;C d-----5-7 a--2--5--       -------- ymin < y1 && y1 <= ymax < y2 --------
    swap.w      d3                                  ;C d-----5-7 a--2--5--   4   Select ymin
    cmp.w       d0, d3                              ;C d-----5-7 a--2--5--   4   ymin>=y0
    bge         .cmp_10                             ;C d-----5-7 a--2--5--  12   
                                                    ;C d-----5-7 a--2--5--       
                                                    ;C d-----5-7 a--2--5--       -------- ymin < y0 && y1 <= ymax < y2 --------
                                                    ;- d-----5-7 a--2--5--       ======== [Sky Upper Lower] ========
                                                    ;S d-----5-7 a--2--5--       -------- [Sky --------
    lea.l       _FUNC_SKYCOPY+ENGINE_Y_MAX*2, a5    ;S d-----5-7 a--2-----  12   Sky copy func
    move.l      (a0)+, a2                           ;S d-----5-7 a--------  12   
    add.w       d3, a2                              ;S d-----5-7 a--------   8   sky offset by ymin
    sub.w       d0, d3                              ;S d-----5-7 a--2-----   4   
    add.w       d3, d3                              ;S d-----5-7 a--2-----   4   
    lea.l       .ret_11(pc), a6                     ;S d-----5-7 a--2-----   8   
    jmp         (a5,d3.w)                           ;S d-----5-7 a--2-----  14   -> .ret_11
.ret_11:                                            ;S d-----5-7 a--2--5--       
                                                    ;R d-----5-7 a--2--5--       -------- Upper --------
                                                    ;R d-----5-7 a--2--5--       -- Fill routine --
    move.w      d4, d7                              ;R d-----5-- a--2--5--   4   int lut_offset = (((word)s1)>>3) & ~3;
    lsr.w       #3, d7                              ;R d-----5-- a--2--5--  12   
    ...
    divu.w      d4, d7                              ;T d-----5-- a--2----- 140   
    and.w       #$1F80, d7                          ;T d-----5-- a--2-----   8   tx &= $1F80;
    move.w      d7, _asm_tex_base                   ;T d-----5-- a--2-----  16   Save texcoords
    move.l      .asm_tex_base(pc), a2               ;T d-----5-- a--------  16   -- Texture source --
    add.w       d7, a2                              ;T d-----5-- a--------   8   
    ...
    add.w       d7, d7                              ;R d-----5-- a--2-----   4   
    add.w       d7, d7                              ;R d-----5-- a--2-----   4   
    lea.l       .ret_12(pc), a6                     ;R d-----5-- a--2-----   8   
    jmp         (a5,d7.w)                           ;R d-----5-- a--2-----  14   -> .ret_12
.ret_12:                                            ;R d-----5-7 a--2-----       
    ...
    lea.l       _FN_SCALERS, a5                     ;R d-----5-- a--2-----  12   
    move.l      (a5,d7.w), a5                       ;R d-----5-- a--2-----  18   
    move.l      .asm_tex_base2(pc), a2              ;T d-----5-7 a--------  16   -- Texture source --
    add.w       _asm_tex_base, a2                   ;T d-----5-7 a--------  20   
    swap.w      d3                                  ;R d-----5-7 a--2-----   4   Select ymax
    add.w       d3, d3                              ;R d-----5-7 a--2-----   4   bottom_offset = 4*ymax
    add.w       d3, d3                              ;R d-----5-7 a--2-----   4   
    move.w      #$4ED6, (a5,d3.w)                   ;R d-----5-7 a--2-----  18   #$4ED6 -> (fill_routine, bottom_offset)
    ...
    jmp         (a5,d7.w)                           ;R d-----5-- a--2-----  14   -> .ret_13
.ret_13:                                            ;R d-----5-7 a--2-----       
    move.w      #$1EEA, (a5,d3.w)                   ;R d-----5-7 a--2-----  18   #$1EEA -> (fill_routine, bottom_offset)
    moveq.l     #0, d3                              ;G d-----5-7 a--2--5--   4   Disable further rendering - clear ymin/ymax
    move.l      d3, rc_ymin-8(a4)                   ;G d-----5-7 a--2--5--  16   
    ...
    bra         .end_loop                           ;- d---3-5-7 a--2--5--  12   
                                                    ;C d-----5-7 a--2--5--       
.cmp_10:                                            ;C d-----5-7 a--2--5--       -------- y0 <= ymin < y1 && y1 <= ymax < y2 --------
                                                    ;- d-----5-7 a--2--5--       ======== [Upper Lower] ========
                                                    ;R d-----5-7 a--2--5--       -------- [Upper --------
                                                    ;R d-----5-7 a--2--5--       -- Fill routine --
    move.w      d4, d7                              ;R d-----5-- a--2--5--   4   int lut_offset = (((word)s1)>>3) & ~3;
    lsr.w       #3, d7                              ;R d-----5-- a--2--5--  12   
    ...
    add.w       d7, a5                              ;R d-----5-- a--2-----   8   
    move.w      #$4ED6, (a5)                        ;R d-----5-7 a--2-----  12   #$4ED6 -> (fill_routine, bottom_offset)
    sub.w       d1, d3                              ;R d-----5-7 a--2-----   4   
    add.w       d3, d3                              ;R d-----5-7 a--2-----   4   top_offset = 4*ymin
    add.w       d3, d3                              ;R d-----5-7 a--2-----   4   
    lea.l       .ret_14(pc), a6                     ;R d-----5-7 a--2-----   8   
    jmp         (a5,d3.w)                           ;R d-----5-7 a--2-----  14   -> .ret_14
.ret_14:                                            ;R d-----5-7 a--2-----       
    move.w      #$1EEA, (a5)                        ;R d-----5-7 a--2-----  12   #$1EEA -> (fill_routine, bottom_offset)
                                                    ;R d-----5-7 a--2--5--       -------- Lower] --------
                                                    ;R d-----5-7 a--2--5--       -- Fill routine --
...
.ret_15:                                            ;R d-----5-7 a--2-----       
    ...
    bra         .end_loop                           ;- d---3-5-7 a--2--5--  12   
                                                    ;C d-----5-7 a--2--5--       
.cmp_9:                                             ;C d-----5-7 a--2--5--       -------- ymin < y1 && y2 <= ymax --------
    swap.w      d3                                  ;C d-----5-7 a--2--5--   4   Select ymin
    cmp.w       d0, d3                              ;C d-----5-7 a--2--5--   4   ymin>=y0
    bge         .cmp_16                             ;C d-----5-7 a--2--5--  12   
                                                    ;C d-----5-7 a--2--5--       
                                                    ;C d-----5-7 a--2--5--       -------- ymin < y0 && y2 <= ymax --------
                                                    ;- d-----5-7 a--2--5--       ======== [Sky Upper Lower Floor] ========
                                                    ;S d-----5-7 a--2--5--       -------- [Sky --------
    lea.l       _FUNC_SKYCOPY+ENGINE_Y_MAX*2, a5    ;S d-----5-7 a--2-----  12   Sky copy func
    move.l      (a0)+, a2                           ;S d-----5-7 a--------  12   
    add.w       d3, a2                              ;S d-----5-7 a--------   8   sky offset by ymin
    sub.w       d0, d3                              ;S d-----5-7 a--2-----   4   
    add.w       d3, d3                              ;S d-----5-7 a--2-----   4   
    lea.l       .ret_17(pc), a6                     ;S d-----5-7 a--2-----   8   
    jmp         (a5,d3.w)                           ;S d-----5-7 a--2-----  14   -> .ret_17
.ret_17:                                            ;S d-----5-7 a--2--5--       
                                                    ;R d-----5-7 a--2--5--       -------- Upper --------
                                                    ;R d-----5-7 a--2--5--       -- Fill routine --
    move.w      d4, d7                              ;R d-----5-- a--2--5--   4   int lut_offset = (((word)s1)>>3) & ~3;
    lsr.w       #3, d7                              ;R d-----5-- a--2--5--  12   
    ...
    add.w       d7, d7                              ;R d-----5-- a--2-----   4   
    add.w       d7, d7                              ;R d-----5-- a--2-----   4   
    lea.l       .ret_18(pc), a6                     ;R d-----5-- a--2-----   8   
    jmp         (a5,d7.w)                           ;R d-----5-- a--2-----  14   -> .ret_18
.ret_18:                                            ;R d-----5-7 a--2-----       
    move.w      #$1EEA, (a5)                        ;R d-----5-7 a--2-----  12   #$1EEA -> (fill_routine, bottom_offset)
                                                    ;R d-----5-7 a--2--5--       -------- Lower --------
                                                    ;R d-----5-7 a--2--5--       -- Fill routine --
    ...
    add.w       d7, d7                              ;R d-----5-- a--2-----   4   
    add.w       d7, d7                              ;R d-----5-- a--2-----   4   
    lea.l       .ret_19(pc), a6                     ;R d-----5-- a--2-----   8   
    jmp         (a5,d7.w)                           ;R d-----5-- a--2-----  14   -> .ret_19
.ret_19:                                            ;R d-----5-7 a--2-----       
    move.w      #$1EEA, (a5)                        ;R d-----5-7 a--2-----  12   #$1EEA -> (fill_routine, bottom_offset)
                                                    ;F d-----5-7 a--2--5--       -------- Floor] --------
    ...
    jmp         (a3,d3.w)                           ;F d-----5-7 a--2--5--  14   -> .end_loop
                                                    ;C d-----5-7 a--2--5--       
.cmp_16:                                            ;C d-----5-7 a--2--5--       -------- y0 <= ymin < y1 && y2 <= ymax --------
                                                    ;- d-----5-7 a--2--5--       ======== [Upper Lower Floor] ========
                                                    ;R d-----5-7 a--2--5--       -------- [Upper --------
                                                    ;R d-----5-7 a--2--5--       -- Fill routine --
    move.w      d4, d7                              ;R d-----5-- a--2--5--   4   int lut_offset = (((word)s1)>>3) & ~3;
    lsr.w       #3, d7                              ;R d-----5-- a--2--5--  12   
    ...
    add.w       d3, d3                              ;R d-----5-7 a--2-----   4   top_offset = 4*ymin
    add.w       d3, d3                              ;R d-----5-7 a--2-----   4   
    lea.l       .ret_20(pc), a6                     ;R d-----5-7 a--2-----   8   
    jmp         (a5,d3.w)                           ;R d-----5-7 a--2-----  14   -> .ret_20
.ret_20:                                            ;R d-----5-7 a--2-----       
    move.w      #$1EEA, (a5)                        ;R d-----5-7 a--2-----  12   #$1EEA -> (fill_routine, bottom_offset)
                                                    ;R d-----5-7 a--2--5--       -------- Lower --------
                                                    ;R d-----5-7 a--2--5--       -- Fill routine --
    ...
    add.w       d7, d7                              ;R d-----5-- a--2-----   4   
    add.w       d7, d7                              ;R d-----5-- a--2-----   4   
    lea.l       .ret_21(pc), a6                     ;R d-----5-- a--2-----   8   
    jmp         (a5,d7.w)                           ;R d-----5-- a--2-----  14   -> .ret_21
.ret_21:                                            ;R d-----5-7 a--2-----       
    move.w      #$1EEA, (a5)                        ;R d-----5-7 a--2-----  12   #$1EEA -> (fill_routine, bottom_offset)
                                                    ;F d-----5-7 a--2--5--       -------- Floor] --------
    swap.w      d3                                  ;F d-----5-7 a--2--5--   4   Select ymax
    ...
    jmp         (a3,d3.w)                           ;F d-----5-7 a--2--5--  14   -> .end_loop
                                                    ;C d-----5-7 a--2--5--       
.cmp_8:                                             ;C d-----5-7 a--2--5--       -------- y1 <= ymin && y1 <= ymax --------
    swap.w      d3                                  ;C d-----5-7 a--2--5--   4   Select ymax
    cmp.w       d2, d3                              ;C d-----5-7 a--2--5--   4   ymax>=y2
    bge         .cmp_22                             ;C d-----5-7 a--2--5--  12   
                                                    ;C d-----5-7 a--2--5--       
    ...
    add.w       d3, d3                              ;R d-----5-7 a--2-----   4   top_offset = 4*ymin
    add.w       d3, d3                              ;R d-----5-7 a--2-----   4   
    lea.l       .ret_23(pc), a6                     ;R d-----5-7 a--2-----   8   
    jmp         (a5,d3.w)                           ;R d-----5-7 a--2-----  14   -> .ret_23
.ret_23:                                            ;R d-----5-7 a--2-----       
    swap.w      d3                                  ;R d-----5-7 a--2-----   4   Select ymax
    move.w      #$1EEA, (a5,d3.w)                   ;R d-----5-7 a--2-----  18   #$1EEA -> (fill_routine, bottom_offset)
    addq.l      #4, a0                              ;S d---3-5-7 a--2--5--   8   SKY was skipped
    ...
    bra         .end_loop                           ;- d---3-5-7 a--2--5--  12   
                                                    ;C d-----5-7 a--2--5--       
.cmp_22:                                            ;C d-----5-7 a--2--5--       -------- y1 <= ymin && y2 <= ymax --------
    swap.w      d3                                  ;C d-----5-7 a--2--5--   4   Select ymin
    cmp.w       d2, d3                              ;C d-----5-7 a--2--5--   4   ymin>=y2
    bge         .cmp_24                             ;C d-----5-7 a--2--5--  12   
                                                    ;C d-----5-7 a--2--5--       
    ...
    add.w       d3, d3                              ;R d-----5-7 a--2-----   4   top_offset = 4*ymin
    add.w       d3, d3                              ;R d-----5-7 a--2-----   4   
    lea.l       .ret_25(pc), a6                     ;R d-----5-7 a--2-----   8   
    jmp         (a5,d3.w)                           ;R d-----5-7 a--2-----  14   -> .ret_25
.ret_25:                                            ;R d-----5-7 a--2-----       
    move.w      #$1EEA, (a5)                        ;R d-----5-7 a--2-----  12   #$1EEA -> (fill_routine, bottom_offset)
                                                    ;F d-----5-7 a--2--5--       -------- Floor] --------
    swap.w      d3                                  ;F d-----5-7 a--2--5--   4   Select ymax
    ...
    jmp         (a3,d3.w)                           ;F d-----5-7 a--2--5--  14   -> .end_loop
                                                    ;C d-----5-7 a--2--5--       
.cmp_24:                                            ;C d-----5-7 a--2--5--       -------- y2 <= ymin && y2 <= ymax --------
                                                    ;- d-----5-7 a--2--5--       ======== [Floor] ========
                                                    ;F d-----5-7 a--2--5--       -------- [Floor] --------
