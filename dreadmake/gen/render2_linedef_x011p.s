    ...
    public _Dread_LineCore_x011p
_Dread_LineCore_x011p:
...
.trace_tex:                                         ;I d-----5-7 a-123----       
    add.l       #$80000000, d6                      ;I d-----5-7 a-123----  16   u += du
                                                    ;- d-----5-7 a-123----       
...
.ret_6:                                             ;F d-----5-- a-123----       
    ...
    move.l      (a3,d5.w), a3                       ;R d-------- a-12-----  18   
                                                    ;T d-----5-- a-12-----       -- Texcoord (persp) --
    move.l      d6, d5                              ;T d-------- a-12-----   4   word tx = u1s /divu/ s1;
    divu.w      d4, d5                              ;T d-------- a-12----- 140   
...
.cmp_5:                                             ;C d-----5-- a-123----       -------- y0 <= ymin < y1 && y0 <= ymax < y1 --------
    ...
    move.l      (a1,d5.w), a1                       ;R d-------- a--23----  18   
                                                    ;T d-----5-- a--23----       -- Texcoord (persp) --
    move.l      d6, d5                              ;T d-------- a--23----   4   word tx = u1s /divu/ s1;
    divu.w      d4, d5                              ;T d-------- a--23---- 140   
