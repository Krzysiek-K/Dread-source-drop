    ...
    public _Dread_LineCoreCheat_x014p
_Dread_LineCoreCheat_x014p:
...
.start:                                             ;- d012----- a01-3----       // FIRST ITERATION STARTS HERE
    ...
    move.w      d0, rc_size_limit(a5)               ;- d-12----- a01-3----   8   end of column - clip sprites
    ...
    move.w      lc_ceil_len_m96(a4), d0             ;F d-12----- a-1-3----  12   jsr(fn1, d0) LUT.w:	Ceil length(x2)
    lea.l       .ceil_ret(pc), a6                   ;F d-12----- a-1-3----   8   
    jmp         (a0,d0.w)                           ;F d-12----- a-1-3----  14   
.ceil_ret:                                          ;F d012----- a01-3----       
                                                    ;T d012----- a01-3----       === Texcoord
    move.l      d6, d0                              ;T d-12----- a01-3----   4   word tx = u1s /divu/ s1;
    divu.w      d4, d0                              ;T d-12----- a01-3---- 140   
    ...
    add.w       d0, a2                              ;T d-12----- a01-3----   8   void *tex @ a2 = _asm_tex_base + tx;
                                                    ;R d012----- a01-3----       === Upper
    move.l      lc_upper_start_m96(a4), a0          ;R d012----- a-1-3----  16   void *fn = line_cheat.upper_start_m64;
    move.w      lc_upper_len_m96_0(a4), d0          ;R d-12----- a-1-3----  12   $ fn[line_cheat.upper_len_m64_0] = $4ED6;  (L = -64..0 / -128..0)
