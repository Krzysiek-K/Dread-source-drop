...
UnaryInstruction		neg (OP_NEG);			//	<dst>
UnaryInstruction		clr (OP_CLR);			//	<dst>
BinaryInstruction		lea	(OP_LEA);			//	<src>, <dst>
BinaryInstruction		add	(OP_ADD);			//	<src>, <dst>
BinaryInstruction		addx(OP_ADDX);			//	<src>, <dst>
...
BinaryInstruction		muls(OP_MULS);			//	<src>, <dst>
BinaryInstruction		mulu(OP_MULU);			//	<src>, <dst>
BinaryInstruction		divs(OP_DIVS);			//	<src>, <dst>
BinaryInstruction		divu(OP_DIVU);			//	<src>, <dst>
...
UnsizedUnaryInstruction	bgt	(OP_BGT);			//	<dst>
UnsizedUnaryInstruction	ble (OP_BLE);			//	<dst>
UnsizedUnaryInstruction	blt	(OP_BLT);			//	<dst>
