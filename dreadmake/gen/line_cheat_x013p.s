    ...
    public _Dread_LineCoreCheat_x013p
_Dread_LineCoreCheat_x013p:
...
.start:                                             ;- d012----- a0123----       // FIRST ITERATION STARTS HERE
    ...
    add.w       lc_ceil_len_m64(a4), d0             ;F d--2----- a-123----  12   shorten to end at texture edge
    lea.l       .ceil_ret(pc), a6                   ;F d--2----- a-123----   8   
    jmp         (a0,d0.w)                           ;F d--2----- a-123----  14   
.ceil_ret:                                          ;F d0-2----- a0123----       
                                                    ;G d0-2----- a0123----       === Gap
    move.w      lc_ceil_ymin_m64(a4), rc_ymin(a5)   ;G d0-2----- a0123----  20   ymin
    add.w       lc_hole_size_m64_0(a4), a7          ;G d0-2----- a0123----  16   
                                                    ;F d0-2----- a0123----       === Floor]
