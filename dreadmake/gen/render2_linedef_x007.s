    ...
    public _Dread_LineCore_x007
_Dread_LineCore_x007:

                                                    ;0 d01---5-- a01234---       ================================ Upper y2 gap ================================
    ...
    move.w      _asm_line_ds, .trace_s+4            ;0 d-123-5-7 a-123-5--  28   
...
.trace_tex:                                         ;1 d-123-5-7 a-123-5--       
    add.w       #$8000, d6                          ;1 d-123-5-7 a-123-5--   8   u += du
                                                    ;1 d-123-5-7 a-123-5--       
.start:                                             ;1 d-123-5-7 a-123-5--       ======== FIRST ITERATION STARTS HERE ========
    ...
    move.w      d6, d2                              ;1 d---3-5-7 a--23-5--   4   word tx = u1s;
    and.w       #$1F80, d2                          ;1 d---3-5-7 a--23-5--   8   tx &= $1F80;
    move.l      .asm_tex_base(pc), a2               ;1 d---3-5-7 a---3-5--  16   -- Texture source --
