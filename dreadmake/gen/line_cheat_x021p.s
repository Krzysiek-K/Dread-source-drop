    ...
    public _Dread_LineCoreCheat_x021p
_Dread_LineCoreCheat_x021p:
...
.start:                                             ;- d012----- a01------       // FIRST ITERATION STARTS HERE
    ...
    move.w      lc_ceil_len_m96(a4), d0             ;S d-1------ a-1------  12   jsr(fn1, d0) LUT.w:	Ceil length(x2)
...
.sky_ret:                                           ;S d01------ a01------       
    ...
    add.w       d0, a2                              ;T d-1------ a01------   8   void *tex @ a2 = _asm_tex_base + tx;
                                                    ;R d01------ a01------       === Upper
    move.l      lc_upper_start_m96(a4), a0          ;R d01------ a-1------  16   void *fn = line_cheat.upper_start_m64;
    move.w      lc_upper_len_m96_m64(a4), d0        ;R d-1------ a-1------  12   $ fn[line_cheat.upper_len_m64_0] = $4ED6;  (L = -64..0 / -128..0)
...
.upper_ret:                                         ;R d-1------ a-1------       
    move.w      #$1EEA, (a0,d0.w)                   ;R d-1------ a-1------  18   $ fn[line_cheat.upper_len_m64_0] = $1EEA;
                                                    ;G d01------ a01------       === Gap
    move.w      lc_ceil_ymin_m64(a4), rc_ymin(a5)   ;G d01------ a01------  20   ymin
    add.w       lc_hole_size_m64_0(a4), a7          ;G d01------ a01------  16   
                                                    ;F d01------ a01------       === Floor]
...
.skyceil_culled:                                    ;- d01------ a01------       Variant 1
                                                    ;T d01------ a01------       === Texcoord
    move.l      d6, d0                              ;T d-1------ a01------   4   word tx = u1s /divu/ s1;
    divu.w      d4, d0                              ;T d-1------ a01------ 140   
    and.w       #$1F80, d0                          ;T d-1------ a01------   8   tx &= $1F80;
    ...
    move.w      lc_upper_endpos_m64(a4), d0         ;R d-------- a01------  12   $ fn[line_cheat.upper_len_m64_0] = $4ED6;  (L = -64..0 / -128..0)
    cmp.w       d0, d1                              ;C d-------- a01------   4   
    bge         .upper_skip1                        ;C d-------- a01------  12   
    move.l      lc_scaler_fn(a4), a0                ;R d-------- a-1------  16   void *fn = line_cheat.upper_start_m64;
    move.w      #$4ED6, (a0,d0.w)                   ;R d-------- a-1------  18   
    lea.l       .upper_ret1(pc), a6                 ;R d-------- a-1------   8   
    jmp         (a0,d1.w)                           ;R d-------- a-1------  14   $ call_a6(fn)	(Z = -64 / -128)
.upper_ret1:                                        ;R d-1------ a-1------       
    move.w      #$1EEA, (a0,d0.w)                   ;R d-1------ a-1------  18   $ fn[line_cheat.upper_len_m64_0] = $1EEA;
.upper_skip1:                                       ;R d01------ a01------       
                                                    ;G d01------ a01------       === Gap
    move.w      lc_ceil_ymin_m64(a4), rc_ymin(a5)   ;G d01------ a01------  20   ymin
    add.w       lc_hole_size_m64_0(a4), a7          ;G d01------ a01------  16   
                                                    ;F d01------ a01------       === Floor]
