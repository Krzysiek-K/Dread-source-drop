    ...
    public _Dread_LineCoreCheat_x001p
_Dread_LineCoreCheat_x001p:
...
.start:                                             ;- d012----- a01-3----       // FIRST ITERATION STARTS HERE
    ...
    add.w       lc_ceil_len_m64(a4), d0             ;F d--2----- a-1-3----  12   shorten to end at texture edge
...
.ceil_ret:                                          ;F d0-2----- a01-3----       
    ...
    add.w       d0, a2                              ;T d--2----- a01-3----   8   void *tex @ a2 = _asm_tex_base + tx;
                                                    ;R d0-2----- a01-3----       === Upper
    move.l      lc_upper_start_m64(a4), a0          ;R d0-2----- a-1-3----  16   void *fn = line_cheat.upper_start_m64;
    move.w      lc_upper_len_m64_0(a4), d0          ;R d--2----- a-1-3----  12   $ fn[line_cheat.upper_len_m64_0] = $4ED6;  (L = -64..0 / -128..0)
