    ...
    public _Dread_LineCore_x022
_Dread_LineCore_x022:

                                                    ;0 d01---5-- a01234---       ================================ Sky y1 gap y3 Lower y4 Floor ================================
    ...
    move.w      line_y4(a5), d3                     ;0 d-----5-7 a--23----  12   
...
.trace_tex:                                         ;1 d---3-5-7 a--23----       
    add.w       #$8000, d6                          ;1 d---3-5-7 a--23----   8   u += du
                                                    ;1 d---3-5-7 a--23----       
...
.ret_5:                                             ;1 d-----5-7 a--23----       
    ...
    move.w      d0, rc_ymin(a4)                     ;1 d---3-5-7 a--23----   8   Update rc_ymin with ystart
    move.l      a7, (a4)                            ;1 d---3-5-7 a--23----  12   Set future drawing start pointer to current pos
    bra         .end_loop                           ;1 d---3-5-7 a--23----  10   
                                                    ;1 d---3-5-7 a--23----       
.cmp_4:                                             ;1 d---3-5-7 a--23----       -------- y0 <= ymin < y1 && y0 <= ymax < y1 --------
                                                    ;1 d---3-5-7 a--23----       ======== [gap] ========
                                                    ;1 d---3-5-7 a--23----       -------- [gap] --------
...
.cmp_1:                                             ;1 d-----5-7 a--23----       -------- y1 <= ymax --------
    ...
    sub.w       d0, d3                              ;1 d-----5-7 a--2-----   4   
    add.w       d3, d3                              ;1 d-----5-7 a--2-----   4   
    lea.l       .ret_9, a6                          ;1 d-----5-7 a--2-----  12   
    jmp         (a3,d3.w)                           ;1 d-----5-7 a--2-----  14   
.ret_9:                                             ;1 d-----5-7 a--23----       
                                                    ;1 d-----5-7 a--23----       -------- gap --------
    move.w      d0, rc_ymin(a4)                     ;1 d-----5-7 a--23----   8   Update rc_ymin with ystart
    move.l      a7, (a4)                            ;1 d-----5-7 a--23----  12   Set future drawing start pointer to current pos
    move.w      d1, rc_ymax(a4)                     ;1 d-----5-7 a--23----   8   Update rc_ymax with yend
    move.w      d1, d7                              ;1 d-----5-- a--23----   4   Add 2*(yend - ystart) to A7
    ...
    move.w      d6, d7                              ;1 d-----5-- a--2-----   4   word tx = u1s;
    and.w       #$1F80, d7                          ;1 d-----5-- a--2-----   8   tx &= $1F80;
    move.l      .asm_tex_base2(pc), a2              ;1 d-----5-- a--------  16   -- Texture source --
    ...
    move.w      d1, d7                              ;1 d-----5-- a--2-----   4   top_offset = 4*ystart
...
.ret_10:                                            ;1 d-----5-7 a--2-----       
    ...
    bra         .end_loop                           ;1 d---3-5-7 a--23----  10   
                                                    ;1 d-----5-7 a--23----       
.cmp_8:                                             ;1 d-----5-7 a--23----       -------- y0 <= ymin < y1 && y1 <= ymax < y2 --------
                                                    ;1 d-----5-7 a--23----       ======== [gap Lower] ========
                                                    ;1 d-----5-7 a--23----       -------- [gap --------
    move.w      d1, rc_ymax(a4)                     ;1 d-----5-7 a--23----   8   Update rc_ymax with yend
    sub.w       d1, d3                              ;1 d-----5-7 a--23----   4   Add 2*(yend - rc_ymin) to A7
...
.ret_11:                                            ;1 d-----5-7 a--2-----       
    ...
    bra         .end_loop                           ;1 d---3-5-7 a--23----  10   
                                                    ;1 d-----5-7 a--23----       
.cmp_7:                                             ;1 d-----5-7 a--23----       -------- ymin < y1 && y2 <= ymax --------
    swap.w      d3                                  ;1 d-----5-7 a--23----   4   Select ymin
    cmp.w       d0, d3                              ;1 d-----5-7 a--23----   4   ymin>=y0
    bge         .cmp_12                             ;1 d-----5-7 a--23----  10   
                                                    ;1 d-----5-7 a--23----       
                                                    ;1 d-----5-7 a--23----       -------- ymin < y0 && y2 <= ymax --------
                                                    ;1 d-----5-7 a--23----       ======== [Sky gap Lower Floor] ========
                                                    ;1 d-----5-7 a--23----       -------- [Sky --------
    lea.l       _FUNC_SKYCOPY+ENGINE_Y_MAX*2, a3    ;1 d-----5-7 a--2-----  12   Sky copy func
    move.l      (a0)+, a2                           ;1 d-----5-7 a--------  12   
    add.w       d3, a2                              ;1 d-----5-7 a--------   8   sky offset by ymin
    sub.w       d0, d3                              ;1 d-----5-7 a--2-----   4   
    add.w       d3, d3                              ;1 d-----5-7 a--2-----   4   
    lea.l       .ret_13, a6                         ;1 d-----5-7 a--2-----  12   
    jmp         (a3,d3.w)                           ;1 d-----5-7 a--2-----  14   
.ret_13:                                            ;1 d-----5-7 a--23----       
                                                    ;1 d-----5-7 a--23----       -------- gap --------
    move.w      d0, rc_ymin(a4)                     ;1 d-----5-7 a--23----   8   Update rc_ymin with ystart
    ...
    move.l      .asm_tex_base2(pc), a2              ;1 d-----5-- a--------  16   -- Texture source --
    add.w       d7, a2                              ;1 d-----5-- a--------   8   
    move.w      d2, d7                              ;1 d-----5-- a--2-----   4   bottom_offset = 4*yend
    add.w       d7, d7                              ;1 d-----5-- a--2-----   4   
    add.w       d7, d7                              ;1 d-----5-- a--2-----   4   
    move.w      #$4ED6, (a3,d7.w)                   ;1 d-----5-- a--2-----  18   #$4ED6 -> (fill_routine, bottom_offset)
    move.w      d1, d5                              ;1 d-------- a--2-----   4   top_offset = 4*ystart
    add.w       d5, d5                              ;1 d-------- a--2-----   4   
    add.w       d5, d5                              ;1 d-------- a--2-----   4   
    lea.l       .ret_14, a6                         ;1 d-------- a--2-----  12   
...
.ret_14:                                            ;1 d-----5-- a--2-----       
    ...
    jmp         (a3,d3.w)                           ;1 d-----5-7 a--2-----  14   
.ret_15:                                            ;1 d---3-5-7 a--23----       
    bra         .end_loop                           ;1 d---3-5-7 a--23----  10   
                                                    ;1 d-----5-7 a--23----       
.cmp_12:                                            ;1 d-----5-7 a--23----       -------- y0 <= ymin < y1 && y2 <= ymax --------
                                                    ;1 d-----5-7 a--23----       ======== [gap Lower Floor] ========
                                                    ;1 d-----5-7 a--23----       -------- [gap --------
    move.w      d1, rc_ymax(a4)                     ;1 d-----5-7 a--23----   8   Update rc_ymax with yend
    sub.w       d1, d3                              ;1 d-----5-7 a--23----   4   Add 2*(yend - rc_ymin) to A7
    neg.w       d3                                  ;1 d-----5-7 a--23----   4   
...
.ret_17:                                            ;1 d---3-5-7 a--23----       
    ...
    bra         .end_loop                           ;1 d---3-5-7 a--23----  10   
                                                    ;1 d-----5-7 a--23----       
.cmp_6:                                             ;1 d-----5-7 a--23----       -------- y1 <= ymin && y1 <= ymax --------
    swap.w      d3                                  ;1 d-----5-7 a--23----   4   Select ymax
    cmp.w       d2, d3                              ;1 d-----5-7 a--23----   4   ymax>=y2
    bge         .cmp_18                             ;1 d-----5-7 a--23----  10   
                                                    ;1 d-----5-7 a--23----       
                                                    ;1 d-----5-7 a--23----       -------- y1 <= ymin < y2 && y1 <= ymax < y2 --------
                                                    ;1 d-----5-7 a--23----       ======== [Lower] ========
                                                    ;1 d-----5-7 a--23----       -------- [Lower] --------
                                                    ;1 d-----5-7 a--23----       -- Fill routine --
    move.w      d4, d7                              ;1 d-----5-- a--23----   4   int lut_offset = (((word)s1)>>3) & ~3;
...
.ret_22:                                            ;1 d---3-5-7 a--23----       
    ...
    bra         .end_loop                           ;1 d---3-5-7 a--23----  10   
                                                    ;1 d-----5-7 a--23----       
.cmp_20:                                            ;1 d-----5-7 a--23----       -------- y2 <= ymin && y2 <= ymax --------
                                                    ;1 d-----5-7 a--23----       ======== [Floor] ========
                                                    ;1 d-----5-7 a--23----       -------- [Floor] --------
    lea.l       _FUNC_COLORFILL+ENGINE_Y_MAX*2, a3  ;1 d-----5-7 a--2-----  12   Color filler func
    move.w      d3, d7                              ;1 d-----5-- a--2-----   4   
