    ...
    public _Dread_LineCoreCheat_x023p
_Dread_LineCoreCheat_x023p:
...
.start:                                             ;- d012----- a01-3----       // FIRST ITERATION STARTS HERE
    ...
    add.w       lc_ceil_len_m128(a4), d0            ;F d--2----- a-1-3----  12   shorten to end at texture edge
...
.ceil_ret:                                          ;F d0-2----- a01-3----       
    ...
    move.l      d6, d0                              ;T d--2----- a01-3----   4   word tx = u1s /divu/ s1;
    divu.w      d4, d0                              ;T d--2----- a01-3---- 140   
    ...
    add.w       d0, a2                              ;T d--2----- a01-3----   8   void *tex @ a2 = _asm_tex_base + tx;
                                                    ;R d0-2----- a01-3----       === Upper
    move.l      lc_upper_start_m128(a4), a0         ;R d0-2----- a-1-3----  16   void *fn = line_cheat.upper_start_m64;
    move.w      lc_upper_len_m128_m96(a4), d0       ;R d--2----- a-1-3----  12   $ fn[line_cheat.upper_len_m64_0] = $4ED6;  (L = -64..0 / -128..0)
...
.upper_ret:                                         ;R d--2----- a-1-3----       
    move.w      #$1EEA, (a0,d0.w)                   ;R d--2----- a-1-3----  18   $ fn[line_cheat.upper_len_m64_0] = $1EEA;
                                                    ;G d0-2----- a01-3----       === Gap
    move.w      lc_ceil_ymin_m96(a4), rc_ymin(a5)   ;G d0-2----- a01-3----  20   ymin
    add.w       lc_hole_size_m96_0(a4), a7          ;G d0-2----- a01-3----  16   
                                                    ;F d0-2----- a01-3----       === Floor]
...
.upper_culled:                                      ;- d0-2----- a01-3----       Variant 1
                                                    ;G d0-2----- a01-3----       === !Gap
    move.l      (a5), a7                            ;G d0-2----- a01-3----  12   byte *dst = render_buffer + offs[x];
    add.w       lc_hole_end_0(a4), a7               ;G d0-2----- a01-3----  16   
                                                    ;F d0-2----- a01-3----       === Floor]
...
.floor_ret1:                                        ;F d012----- a01-3----       
    dbra.w      d3, .loop                           ;- d012----- a01-3----  12   LOOP END
    bra         .end                                ;- d012----- a01-3----  12   End of variant
.skyceil_culled:                                    ;- d0-2----- a01-3----       Variant 2
                                                    ;T d0-2----- a01-3----       === Texcoord
    move.l      d6, d0                              ;T d--2----- a01-3----   4   word tx = u1s /divu/ s1;
    divu.w      d4, d0                              ;T d--2----- a01-3---- 140   
    and.w       #$1F80, d0                          ;T d--2----- a01-3----   8   tx &= $1F80;
    ...
    move.w      lc_upper_endpos_m96(a4), d0         ;R d-------- a01-3----  12   $ fn[line_cheat.upper_len_m64_0] = $4ED6;  (L = -64..0 / -128..0)
    cmp.w       d0, d2                              ;C d-------- a01-3----   4   
    bge         .upper_culled2                      ;C d-------- a01-3----  12   
    move.l      lc_scaler_fn(a4), a0                ;R d-------- a-1-3----  16   void *fn = line_cheat.upper_start_m64;
    move.w      #$4ED6, (a0,d0.w)                   ;R d-------- a-1-3----  18   
    lea.l       .upper_ret2(pc), a6                 ;R d-------- a-1-3----   8   
    jmp         (a0,d2.w)                           ;R d-------- a-1-3----  14   $ call_a6(fn)	(Z = -64 / -128)
.upper_ret2:                                        ;R d--2----- a-1-3----       
    move.w      #$1EEA, (a0,d0.w)                   ;R d--2----- a-1-3----  18   $ fn[line_cheat.upper_len_m64_0] = $1EEA;
.upper_skip2:                                       ;R d0-2----- a01-3----       
                                                    ;G d0-2----- a01-3----       === Gap
    move.w      lc_ceil_ymin_m96(a4), rc_ymin(a5)   ;G d0-2----- a01-3----  20   ymin
    add.w       lc_hole_size_m96_0(a4), a7          ;G d0-2----- a01-3----  16   
                                                    ;F d0-2----- a01-3----       === Floor]
.floor_start2:                                      ;F d0-2----- a01-3----       
    swap.w      d5                                  ;F d0-2----- a01-3----   4   
    lea.l       _FUNC_COLORFILL+ENGINE_Y_MID*2, a0  ;F d0-2----- a-1-3----  12   Color filler func
    move.w      lc_floor_start_0(a4), d0            ;F d--2----- a-1-3----  12   jsr (fn1,d0)		LUT.w:	Fill func start		(x2)	(fills to screen end)
    move.w      d0, rc_ymax(a5)                     ;F d--2----- a-1-3----   8   ymax = Gap end
    sub.w       d1, d0                              ;F d--2----- a-1-3----   4   clip ymax
    lea.l       .floor_ret2(pc), a6                 ;F d-12----- a-1-3----   8   
    jmp         (ENGINE_Y_MAX-ENGINE_Y_MID)*2(a0,d0.w);F d-12----- a-1-3----  14   
.floor_ret2:                                        ;F d012----- a01-3----       
    dbra.w      d3, .loop                           ;- d012----- a01-3----  12   LOOP END
    bra         .end                                ;- d012----- a01-3----  12   End of variant
.upper_culled2:                                     ;- d0-2----- a01-3----       Variant 3
                                                    ;G d0-2----- a01-3----       === !Gap
    move.l      (a5), a7                            ;G d0-2----- a01-3----  12   byte *dst = render_buffer + offs[x];
    add.w       lc_hole_end_0(a4), a7               ;G d0-2----- a01-3----  16   
                                                    ;F d0-2----- a01-3----       === Floor]
.floor_start3:                                      ;F d0-2----- a01-3----       
    swap.w      d5                                  ;F d0-2----- a01-3----   4   
    lea.l       _FUNC_COLORFILL+ENGINE_Y_MID*2, a0  ;F d0-2----- a-1-3----  12   Color filler func
    move.w      lc_floor_start_0(a4), d0            ;F d--2----- a-1-3----  12   jsr (fn1,d0)		LUT.w:	Fill func start		(x2)	(fills to screen end)
    move.w      d0, rc_ymax(a5)                     ;F d--2----- a-1-3----   8   ymax = Gap end
    sub.w       d1, d0                              ;F d--2----- a-1-3----   4   clip ymax
    lea.l       .floor_ret3(pc), a6                 ;F d-12----- a-1-3----   8   
    jmp         (ENGINE_Y_MAX-ENGINE_Y_MID)*2(a0,d0.w);F d-12----- a-1-3----  14   
.floor_ret3:                                        ;F d012----- a01-3----       
    dbra.w      d3, .loop                           ;- d012----- a01-3----  12   LOOP END
