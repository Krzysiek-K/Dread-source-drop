    ...
    public _Dread_LineCoreCheat_x005p
_Dread_LineCoreCheat_x005p:
...
.start:                                             ;- d012----- a01-3----       // FIRST ITERATION STARTS HERE
    ...
    move.w      d0, rc_size_limit(a5)               ;- d--2----- a01-3----   8   end of column - clip sprites
...
.ceil_ret:                                          ;F d0-2----- a01-3----       
    ...
    move.w      lc_upper_len_m128_0(a4), d0         ;R d--2----- a-1-3----  12   $ fn[line_cheat.upper_len_m64_0] = $4ED6;  (L = -64..0 / -128..0)
...
.floor_ret:                                         ;F d012----- a01-3----       
    move.w      #0, rc_ymax(a5)                     ;- d012----- a01-3----  12   ymax = 0		(block further visibility)
...
.skyceil_culled:                                    ;- d0-2----- a01-3----       Variant 1
    ...
    move.w      lc_upper_endpos_0(a4), d0           ;R d-------- a01-3----  12   $ fn[line_cheat.upper_len_m64_0] = $4ED6;  (L = -64..0 / -128..0)
