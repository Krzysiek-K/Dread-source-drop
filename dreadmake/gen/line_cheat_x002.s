    ...
    public _Dread_LineCoreCheat_x002
_Dread_LineCoreCheat_x002:
...
.start:                                             ;- d012----- a01------       // FIRST ITERATION STARTS HERE
    ...
    move.w      lc_ceil_len_m64(a4), d0             ;S d-12----- a-1------  12   jsr(fn1, d0) LUT.w:	Ceil length(x2)
...
.sky_ret:                                           ;S d012----- a01------       
    ...
    add.w       d0, a2                              ;T d-12----- a01------   8   void *tex @ a2 = _asm_tex_base + tx;
                                                    ;R d012----- a01------       === Upper
    move.l      lc_upper_start_m64(a4), a0          ;R d012----- a-1------  16   void *fn = line_cheat.upper_start_m64;
    move.w      lc_upper_len_m64_0(a4), d0          ;R d-12----- a-1------  12   $ fn[line_cheat.upper_len_m64_0] = $4ED6;  (L = -64..0 / -128..0)
