    ...
    public _Dread_LineCore_x004p
_Dread_LineCore_x004p:

                                                    ;s d01---567 a01234---       ================================ gap y3 Floor ================================
    ...
    move.w      line_y3(a5), d1                     ;s d--2--567 a0123----  12   
    ...
    move.b      line_floor_col(a5), d5              ;s d-12---67 a0123----  12   
...
.start:                                             ;- d-12--567 a-123-5--       ======== FIRST ITERATION STARTS HERE ========
    ...
    bge         .cmp_1                              ;C d--2--567 a-123-5--  12   
                                                    ;C d-12--567 a-123-5--       
                                                    ;C d-12--567 a-123-5--       -------- ymin < y0 && ymax < y0 --------
...
.cmp_1:                                             ;C d--2--567 a-123-5--       -------- y0 <= ymax --------
    ...
    bge         .cmp_2                              ;C d--2--567 a-123-5--  12   
                                                    ;C d--2--567 a-123-5--       
                                                    ;C d--2--567 a-123-5--       -------- ymin < y0 && y0 <= ymax --------
                                                    ;- d--2--567 a-123-5--       ======== [gap Floor] ========
                                                    ;G d--2--567 a-123-5--       -------- [gap --------
    move.w      d0, rc_ymax-8(a4)                   ;G d--2--567 a-123-5--  12   Update rc_ymax with yend
    sub.w       d0, d1                              ;G d--2--567 a-123-5--   4   Add 2*(yend - rc_ymin) to A7
    neg.w       d1                                  ;G d--2--567 a-123-5--   4   
    add.w       d1, d1                              ;G d--2--567 a-123-5--   4   
    add.w       d1, a7                              ;G d--2--567 a-123-5--   8   
                                                    ;F d--2--567 a-123-5--       -------- Floor] --------
    swap.w      d1                                  ;F d--2--567 a-123-5--   4   Select ymax
    sub.w       d0, d1                              ;F d--2--567 a-123-5--   4   
    neg.w       d1                                  ;F d--2--567 a-123-5--   4   
    add.w       d1, d1                              ;F d--2--567 a-123-5--   4   
    lea.l       .end_loop(pc), a6                   ;F d--2--567 a-123-5--   8   
    jmp         (a0,d1.w)                           ;F d--2--567 a-123-5--  14   -> .end_loop
                                                    ;C d--2--567 a-123-5--       
.cmp_2:                                             ;C d--2--567 a-123-5--       -------- y0 <= ymin && y0 <= ymax --------
                                                    ;- d--2--567 a-123-5--       ======== [Floor] ========
                                                    ;F d--2--567 a-123-5--       -------- [Floor] --------
    ...
    moveq.l     #0, d1                              ;G d-----567 a-123-5--   4   Disable further rendering - clear ymin/ymax
    move.l      d1, rc_ymin-8(a4)                   ;G d-----567 a-123-5--  16   
    move.w      d4, rc_size_limit-8(a4)             ;G d-1---567 a-123-5--  12   
    lea.l       .end_loop(pc), a6                   ;F d-1---567 a-123-5--   8   
    jmp         (a0,d2.w)                           ;F d-1---567 a-123-5--  14   -> .end_loop
                                                    ;- d-12--567 a-123-5--       
                                                    ;- d-12--567 a-123-5--       
