    ...
    public _Dread_LineCoreCheat_x024
_Dread_LineCoreCheat_x024:
...
.start:                                             ;- d012----- a01------       // FIRST ITERATION STARTS HERE
    ...
    move.w      lc_ceil_len_m128(a4), d0            ;S d-12----- a-1------  12   jsr(fn1, d0) LUT.w:	Ceil length(x2)
    lea.l       .sky_ret(pc), a6                    ;S d-12----- a-1------   8   
    jmp         (a0,d0.w)                           ;S d-12----- a-1------  14   
.sky_ret:                                           ;S d012----- a01------       
                                                    ;T d012----- a01------       === Texcoord
    move.l      d6, d0                              ;T d-12----- a01------   4   word tx = u1s & $1F80;
    ...
    add.w       d0, a2                              ;T d-12----- a01------   8   void *tex @ a2 = _asm_tex_base + tx;
                                                    ;R d012----- a01------       === Upper
    move.l      lc_upper_start_m128(a4), a0         ;R d012----- a-1------  16   void *fn = line_cheat.upper_start_m64;
    move.w      lc_upper_len_m128_m96(a4), d0       ;R d-12----- a-1------  12   $ fn[line_cheat.upper_len_m64_0] = $4ED6;  (L = -64..0 / -128..0)
...
.upper_ret:                                         ;R d-12----- a-1------       
    move.w      #$1EEA, (a0,d0.w)                   ;R d-12----- a-1------  18   $ fn[line_cheat.upper_len_m64_0] = $1EEA;
                                                    ;G d012----- a01------       === Gap
    move.w      lc_ceil_ymin_m96(a4), rc_ymin(a5)   ;G d012----- a01------  20   ymin
    add.w       lc_hole_size_m96_0(a4), a7          ;G d012----- a01------  16   
                                                    ;F d012----- a01------       === Floor
